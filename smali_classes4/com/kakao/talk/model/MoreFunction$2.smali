.class public final enum Lcom/kakao/talk/model/MoreFunction$2;
...
.method public newIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 1
    invoke-static {p2}, Lcom/kakao/talk/billing/util/BillingRefererUtils;->b(Ljava/lang/String;)V

    .line 2
    sget-object p2, Lcom/kakao/talk/itemstore/StoreMainActivity$TabType;->TAB_TYPE_HOME:Lcom/kakao/talk/itemstore/StoreMainActivity$TabType;

    const-string v0, "talk_add"

    invoke-static {p1, p2, v0}, Lcom/kakao/talk/itemstore/utils/StoreActivityUtil;->b(Landroid/content/Context;Lcom/kakao/talk/itemstore/StoreMainActivity$TabType;Ljava/lang/String;)Landroid/content/Intent;
