.class public Lcom/kakao/talk/database/dao/OpenChatBotCommandDao_Impl$2;
...
.method public bridge synthetic a(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/kakao/talk/database/dao/OpenChatBotCommandDao_Impl$2;->a(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/kakao/talk/database/entity/OpenChatBotCommandEntity;)V
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `openchat_bot_command` SET `id` = ?,`bot_id` = ?,`chat_id` = ?,`link_id` = ?,`name` = ?,`description` = ?,`revision` = ?,`updated_at` = ? WHERE `id` = ?"
