.class public final Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;",
...
.method public final a(Lcom/kakao/talk/db/model/chatlog/ChatLog;Z)Lcom/iap/ac/android/r7/b;
    ...
    .line 10
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$bookmark$1;

    invoke-direct {v0, p2, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$bookmark$1;-><init>(ZLcom/kakao/talk/db/model/chatlog/ChatLog;)V
...
.method public final a(Lcom/kakao/talk/drawer/model/Media;Z)Lcom/iap/ac/android/r7/b;
    ...
    sget-object v2, Lcom/kakao/talk/drawer/DrawerType;->FILE:Lcom/kakao/talk/drawer/DrawerType;
...
.method public a(Ljava/util/List;)Lcom/iap/ac/android/r7/b;
    ...
    .line 14
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$delete$1;

    invoke-direct {v0, p0}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$delete$1;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;)V
    ...
    .line 15
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$delete$2;

    invoke-virtual {p0}, Lcom/kakao/talk/drawer/repository/manager/DrawerRepoManager;->c()Lcom/kakao/talk/net/retrofit/service/DrawerService;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$delete$2;-><init>(Lcom/kakao/talk/net/retrofit/service/DrawerService;)V

    new-instance v1, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$sam$io_reactivex_functions_Function$0;

    invoke-direct {v1, v0}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$sam$io_reactivex_functions_Function$0;-><init>(Lcom/iap/ac/android/q9/b;)V
...
.method public a(Lcom/kakao/talk/drawer/repository/DrawerQuery;Lcom/kakao/talk/drawer/repository/DrawerQuery$LoadParams;)Lcom/iap/ac/android/r7/z;
    ...
    .line 3
    new-instance v1, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$requestList$single$1;

    invoke-direct {v1, p0, p2}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$requestList$single$1;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;Lcom/kakao/talk/drawer/repository/DrawerQuery$LoadParams;)V
    ...
    .line 5
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$requestList$1;

    invoke-direct {v0, p0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$requestList$1;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;Lcom/kakao/talk/drawer/repository/DrawerQuery;)V
...
.method public a(Lcom/kakao/talk/drawer/repository/DrawerQuery;)V
    ...
    .line 22
    sget-object v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$1;->a:Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$1;
    ...
    .line 24
    sget-object v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$2;->a:Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$2;
    ...
    .line 26
    :cond_2
    invoke-virtual {p0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;->b(Lcom/kakao/talk/drawer/repository/DrawerQuery;)Lcom/iap/ac/android/r7/z;
    ...
    .line 28
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$3;

    invoke-direct {v0, p0}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$3;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;)V
    ...
    .line 29
    sget-object v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$4;->a:Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$4;

    invoke-virtual {p1, v0}, Lcom/iap/ac/android/r7/z;->g(Lcom/iap/ac/android/y7/i;)Lcom/iap/ac/android/r7/z;

    move-result-object p1

    const-string v0, "if(drawerMeta.isServerAp\u2026t.onSuccess(0L to 0L) } }"

    invoke-static {p1, v0}, Lcom/iap/ac/android/r9/p;->a(Ljava/lang/Object;Ljava/lang/String;)V

    .line 30
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$5;

    invoke-direct {v0, p0}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$5;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;)V

    .line 31
    new-instance v1, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$6;

    invoke-direct {v1, p0}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getCountWithSize$6;-><init>(Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager;)V
...
.method public final b(Lcom/kakao/talk/drawer/repository/DrawerQuery;)Lcom/iap/ac/android/r7/z;
    ...
    .line 1
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getLocalCountWithSize$1;

    invoke-direct {v0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerFileRepoManager$getLocalCountWithSize$1;-><init>(Lcom/kakao/talk/drawer/repository/DrawerQuery;)V
