.class public final Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;
.super Lcom/kakao/talk/drawer/viewmodel/DrawerViewModel;
.source "DrawerLinkViewModel.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;",
...
# instance fields
.field public final k:Lcom/kakao/talk/drawer/repository/LinkMigrationManager;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field

.field public final l:Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>(Lcom/kakao/talk/drawer/model/DrawerMeta;)V
    ...
    .line 2
    new-instance v0, Lcom/kakao/talk/drawer/repository/LinkMigrationManager;

    invoke-direct {v0}, Lcom/kakao/talk/drawer/repository/LinkMigrationManager;-><init>()V

    iput-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->k:Lcom/kakao/talk/drawer/repository/LinkMigrationManager;

    .line 3
    new-instance v0, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;

    invoke-direct {v0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;-><init>(Lcom/kakao/talk/drawer/model/DrawerMeta;)V

    iput-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->l:Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;
    ...
    iput-object p1, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->m:Lcom/iap/ac/android/w7/a;

    .line 5
    invoke-virtual {p0}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->R()Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;
    ...
    .line 6
    new-instance v0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$1;

    invoke-direct {v0, p0}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$1;-><init>(Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;)V

    sget-object v1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$2;->a:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$2;
    ...
    iget-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->m:Lcom/iap/ac/android/w7/a;
...
.method public L()V
    ...
    .line 3
    iget-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->k:Lcom/kakao/talk/drawer/repository/LinkMigrationManager;

    invoke-virtual {v0}, Lcom/kakao/talk/drawer/repository/LinkMigrationManager;->a()V

    return-void
.end method

.method public R()Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    .line 2
    iget-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->l:Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;
...
.method public final W()Lcom/kakao/talk/drawer/ui/DrawerAdapter;
    ...
    .line 1
    iget-object v0, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->n:Lcom/kakao/talk/drawer/ui/DrawerAdapter;

    return-object v0
.end method

.method public final X()Lcom/kakao/talk/drawer/repository/LinkMigrationManager;
    .locals 1
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
...
.method public final a(Ljava/lang/String;Ljava/util/List;)Lcom/iap/ac/android/w7/b;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Lcom/kakao/talk/drawer/repository/manager/DrawerRepoManager;->a(Ljava/lang/String;Ljava/util/List;)Lcom/iap/ac/android/r7/b;
    ...
    .line 30
    sget-object v0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$1;->a:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$1;

    invoke-virtual {p1, v0}, Lcom/iap/ac/android/r7/b;->a(Lcom/iap/ac/android/y7/g;)Lcom/iap/ac/android/r7/b;

    move-result-object p1

    const-string v0, "drawerRepoManager.delete\u2026oOnError { Logger.w(it) }"

    invoke-static {p1, v0}, Lcom/iap/ac/android/r9/p;->a(Ljava/lang/Object;Ljava/lang/String;)V

    .line 31
    new-instance v0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$2;

    invoke-direct {v0, p0, p2}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$2;-><init>(Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;Ljava/util/List;)V

    .line 32
    sget-object p2, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$3;->INSTANCE:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDeleteFolderContents$3;

    .line 33
    invoke-static {p1, p2, v0}, Lcom/iap/ac/android/u8/g;->a(Lcom/iap/ac/android/r7/b;Lcom/iap/ac/android/q9/b;Lcom/iap/ac/android/q9/a;)Lcom/iap/ac/android/w7/b;

    move-result-object p1

    .line 34
    iget-object p2, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->m:Lcom/iap/ac/android/w7/a;
...
.method public final a(Lcom/kakao/talk/drawer/model/DrawerItem;Z)V
    ...
    .line 21
    instance-of v0, p1, Lcom/kakao/talk/drawer/model/Link;
    ...
    check-cast v1, Lcom/kakao/talk/drawer/model/Link;

    invoke-virtual {v0, v1, p2}, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;->a(Lcom/kakao/talk/drawer/model/Link;Z)Lcom/iap/ac/android/r7/b;
    ...
    invoke-virtual {v0, v1, p2}, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;->a(Lcom/kakao/talk/db/model/UrlLog;Z)Lcom/iap/ac/android/r7/b;
    ...
    .line 24
    new-instance v1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqBookmark$1;

    invoke-direct {v1, p1, p2}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqBookmark$1;-><init>(Lcom/kakao/talk/drawer/model/DrawerItem;Z)V

    .line 25
    sget-object p1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqBookmark$2;->INSTANCE:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqBookmark$2;
...
.method public final a(Lcom/kakao/talk/drawer/model/DrawerItem;ZLcom/kakao/talk/drawer/model/Folder;)V
    ...
    .line 12
    invoke-virtual {p0}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->Y()Z
    ...
    .line 13
    invoke-virtual {p0, p1}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->b(Lcom/kakao/talk/drawer/model/DrawerItem;)V
    ...
    .line 17
    iget-object p1, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->n:Lcom/kakao/talk/drawer/ui/DrawerAdapter;
    ...
    .line 18
    :cond_3
    invoke-virtual {p0, p1}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->a(Lcom/kakao/talk/drawer/model/DrawerItem;)Z
...
.method public a(Lcom/kakao/talk/drawer/repository/DrawerQuery;)V
    ...
    invoke-virtual {v0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;->a(Lcom/kakao/talk/drawer/repository/DrawerQuery;)V

    .line 37
    :cond_0
    instance-of v0, p1, Lcom/kakao/talk/drawer/repository/DrawerQuery$DrawerLocalQuery;
    ...
    invoke-virtual {p1}, Lcom/kakao/talk/drawer/repository/DrawerQuery$DrawerLocalQuery;->e()Ljava/util/List;

    move-result-object p1

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1}, Lcom/kakao/talk/drawer/repository/LinkMigrationManager;->b(Ljava/util/List;Z)V
...
.method public final a(Lcom/kakao/talk/drawer/ui/DrawerAdapter;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->n:Lcom/kakao/talk/drawer/ui/DrawerAdapter;
...
.method public final a(Ljava/util/List;)V
    ...
    .line 4
    iget-object v1, p0, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->n:Lcom/kakao/talk/drawer/ui/DrawerAdapter;
...
.method public final b(Ljava/util/List;)Lcom/iap/ac/android/w7/b;
    ...
    invoke-virtual {v0, p1}, Lcom/kakao/talk/drawer/repository/manager/DrawerLinkRepoManager;->a(Ljava/util/List;)Lcom/iap/ac/android/r7/b;
    ...
    .line 4
    sget-object v1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$1;->a:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$1;
    ...
    .line 5
    new-instance v1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$2;

    invoke-direct {v1, p0, p1}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$2;-><init>(Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;Ljava/util/List;)V

    .line 6
    sget-object p1, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$3;->INSTANCE:Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel$reqDelete$3;
...
.method public final b(Lcom/kakao/talk/drawer/model/DrawerItem;)V
    ...
    invoke-virtual {p0, p1}, Lcom/kakao/talk/drawer/viewmodel/DrawerLinkViewModel;->a(Ljava/util/List;)V

    return-void
.end method

.method public final c(Lcom/kakao/talk/drawer/model/DrawerItem;)V
    .locals 2
    .param p1    # Lcom/kakao/talk/drawer/model/DrawerItem;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-virtual {v0, v1}, Lcom/kakao/talk/drawer/repository/DrawerItemList;->a(Lcom/kakao/talk/drawer/model/DrawerKey;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/kakao/talk/drawer/repository/DrawerItemList;->e(Lcom/kakao/talk/drawer/model/DrawerItem;)V
    ...
    invoke-virtual {v0, p1}, Lcom/kakao/talk/drawer/repository/DrawerItemList;->d(Lcom/kakao/talk/drawer/model/DrawerItem;)I
