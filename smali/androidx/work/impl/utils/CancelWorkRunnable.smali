...
.method public static a(Ljava/lang/String;Landroidx/work/impl/WorkManagerImpl;)Landroidx/work/impl/utils/CancelWorkRunnable;
    .locals 1
...
.method public static a(Ljava/lang/String;Landroidx/work/impl/WorkManagerImpl;Z)Landroidx/work/impl/utils/CancelWorkRunnable;
    .locals 1
    .param p0    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public static a(Ljava/util/UUID;Landroidx/work/impl/WorkManagerImpl;)Landroidx/work/impl/utils/CancelWorkRunnable;
    .locals 1
...
.method public final a(Landroidx/work/impl/WorkDatabase;Ljava/lang/String;)V
    ...
    .line 17
    invoke-interface {v0, p2}, Landroidx/work/impl/model/WorkSpecDao;->b(Ljava/lang/String;)Landroidx/work/WorkInfo$State;
    ...
    .line 20
    :cond_0
    invoke-interface {p1, p2}, Landroidx/work/impl/model/DependencyDao;->a(Ljava/lang/String;)Ljava/util/List;
...
.method public a(Landroidx/work/impl/WorkManagerImpl;)V
    .locals 2

    .line 7
    invoke-virtual {p1}, Landroidx/work/impl/WorkManagerImpl;->c()Landroidx/work/Configuration;
    ...
    .line 9
    invoke-virtual {p1}, Landroidx/work/impl/WorkManagerImpl;->f()Ljava/util/List;

    move-result-object p1

    .line 10
    invoke-static {v0, v1, p1}, Landroidx/work/impl/Schedulers;->a(Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
...
.method public a(Landroidx/work/impl/WorkManagerImpl;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/work/impl/utils/CancelWorkRunnable;->a(Landroidx/work/impl/WorkDatabase;Ljava/lang/String;)V
    ...
    .line 4
    invoke-virtual {v0, p2}, Landroidx/work/impl/Processor;->f(Ljava/lang/String;)Z
    ...
    .line 6
    invoke-interface {v0, p2}, Landroidx/work/impl/Scheduler;->a(Ljava/lang/String;)V
...
.method public run()V
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0}, Landroidx/work/impl/utils/CancelWorkRunnable;->b()V
