...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/appcompat/widget/AppCompatDrawableManager;->c()V
.end annotation
...
.method public final a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/content/res/AppCompatResources;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 15
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 17
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->c(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 19
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 21
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a([II)Z
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/ThemeUtils;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public a(Landroidx/appcompat/widget/ResourceManagerInternal;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/ResourceManagerInternal;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_1
    invoke-static {p2, p3}, Landroidx/appcompat/widget/AppCompatDrawableManager;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a([II)Z
    ...
    .line 45
    invoke-static {p1, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/ThemeUtils;->a(Landroid/content/Context;I)I
...
.method public b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 18
    invoke-virtual {p0, p2, v0, v4}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 22
    invoke-virtual {p0, p2, v0, v3}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 24
    invoke-static {p1, p3}, Landroidx/appcompat/widget/ThemeUtils;->b(Landroid/content/Context;I)I
    ...
    .line 26
    invoke-virtual {p0, p2, p1, p3}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 30
    invoke-static {p1, v0}, Landroidx/appcompat/widget/ThemeUtils;->a(Landroid/content/Context;I)I
...
.method public final d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/ThemeUtils;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/ThemeUtils;->a(Landroid/content/Context;I)I
