...
# static fields
.field public static final H2:Landroid/util/Property;
...
.method public static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroidx/transition/ChangeTransform;->I2:Z
...
.method public a(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    .line 13
    invoke-virtual {p0, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V

    .line 14
    :cond_4
    invoke-virtual {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->a(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    .line 16
    invoke-virtual {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
...
.method public final a(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    .locals 12
...
.method public a(Landroidx/transition/TransitionValues;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeTransform;->d(Landroidx/transition/TransitionValues;)V
...
.method public final a(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    .line 38
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->b(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
...
.method public final b(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    .locals 3
    ...
    .line 4
    invoke-static {p1, v2}, Landroidx/transition/ViewUtils;->c(Landroid/view/View;Landroid/graphics/Matrix;)V

    .line 5
    invoke-static {v0, p1, v2}, Landroidx/transition/GhostViewUtils;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroidx/transition/GhostViewImpl;
    ...
    invoke-interface {p1, v1, v2}, Landroidx/transition/GhostViewImpl;->a(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    .line 12
    invoke-static {p1, p2}, Landroidx/transition/ViewUtils;->a(Landroid/view/View;F)V

    :cond_2
    const/high16 p1, 0x3f800000    # 1.0f

    .line 13
    invoke-static {v0, p1}, Landroidx/transition/ViewUtils;->a(Landroid/view/View;F)V

    :cond_3
    return-void
.end method

.method public final b(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    .locals 4
...
.method public final d(Landroidx/transition/TransitionValues;)V
    ...
    .line 13
    invoke-static {v2, v1}, Landroidx/transition/ViewUtils;->b(Landroid/view/View;Landroid/graphics/Matrix;)V
