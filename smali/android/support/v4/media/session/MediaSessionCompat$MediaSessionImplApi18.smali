...
.method public a(J)I
    ...
    .line 5
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->a(J)I
...
.method public a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 6
    sget-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi18;->F:Z
    ...
    .line 8
    sput-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplApi18;->F:Z
    ...
    .line 10
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->a(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 4
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->h:Landroid/media/RemoteControlClient;
...
.method public b(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 2
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->g:Landroid/media/AudioManager;
    ...
    .line 3
    :cond_0
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->b(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
...
.method public c(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 6
    :cond_1
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->h:Landroid/media/RemoteControlClient;
