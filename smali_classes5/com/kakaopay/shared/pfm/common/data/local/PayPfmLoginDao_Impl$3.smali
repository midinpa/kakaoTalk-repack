.class public Lcom/kakaopay/shared/pfm/common/data/local/PayPfmLoginDao_Impl$3;
...
.method public bridge synthetic a(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/kakaopay/shared/pfm/common/data/local/PayPfmLoginDao_Impl$3;->a(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/kakaopay/shared/pfm/common/data/local/PayPfmLogin;)V
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `pfm_login` SET `co` = ?,`og` = ?,`so` = ?,`tp` = ?,`ip` = ?,`ps` = ?,`js` = ?,`ls` = ? WHERE `co` = ? AND `og` = ? AND `so` = ?"
