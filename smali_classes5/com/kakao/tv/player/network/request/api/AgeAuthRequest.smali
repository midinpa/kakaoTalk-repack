.class public final Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;",
...
.method public constructor <init>(Lcom/kakao/tv/player/network/request/http/HttpRequest;Lcom/kakao/tv/player/network/action/Action1;Lcom/kakao/tv/player/network/action/Action1;)V
    ...
    iput-object p2, p0, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;->d:Lcom/kakao/tv/player/network/action/Action1;

    iput-object p3, p0, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;->e:Lcom/kakao/tv/player/network/action/Action1;

    return-void
.end method

.method public static final synthetic a(Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;)Lcom/kakao/tv/player/network/action/Action1;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;->e:Lcom/kakao/tv/player/network/action/Action1;

    return-object p0
.end method

.method public static final synthetic b(Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;)Lcom/kakao/tv/player/network/request/http/HttpRequest;
    .locals 0
...
.method public static final synthetic c(Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;)Lcom/kakao/tv/player/network/action/Action1;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;->d:Lcom/kakao/tv/player/network/action/Action1;
...
.method public a(Lcom/kakao/tv/player/network/request/base/Response;)V
    ...
    const-class v1, Lcom/kakao/tv/player/models/klimt/AgeAuth;
    ...
    new-instance v1, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest$onSuccess$1;

    invoke-direct {v1, p0, p1}, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest$onSuccess$1;-><init>(Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;Lcom/kakao/tv/player/models/klimt/AgeAuth;)V
...
.method public a(Ljava/lang/Throwable;)V
    ...
    new-instance v1, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest$onFailed$1;

    invoke-direct {v1, p0, p1}, Lcom/kakao/tv/player/network/request/api/AgeAuthRequest$onFailed$1;-><init>(Lcom/kakao/tv/player/network/request/api/AgeAuthRequest;Ljava/lang/Throwable;)V
