.class public abstract Lcom/iap/ac/android/q7/a;
...
# virtual methods
.method public final a(Lio/fabric/sdk/android/services/network/HttpRequest;Lcom/iap/ac/android/q7/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 1

    .line 15
    iget-object p2, p2, Lcom/iap/ac/android/q7/d;->a:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/iap/ac/android/k7/a;->kit:Lcom/iap/ac/android/i7/h;

    .line 17
    invoke-virtual {p2}, Lcom/iap/ac/android/i7/h;->getVersion()Ljava/lang/String;
...
.method public a(Lcom/iap/ac/android/i7/j;)Ljava/lang/String;
    .locals 3
    ...
    invoke-virtual {p1}, Lcom/iap/ac/android/i7/j;->b()Ljava/lang/String;
...
.method public a(Lcom/iap/ac/android/q7/d;)Z
    .locals 5
    ...
    .line 2
    invoke-virtual {p0, v0, p1}, Lcom/iap/ac/android/q7/a;->a(Lio/fabric/sdk/android/services/network/HttpRequest;Lcom/iap/ac/android/q7/d;)Lio/fabric/sdk/android/services/network/HttpRequest;

    .line 3
    invoke-virtual {p0, v0, p1}, Lcom/iap/ac/android/q7/a;->b(Lio/fabric/sdk/android/services/network/HttpRequest;Lcom/iap/ac/android/q7/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    .line 5
    iget-object v1, p1, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;
    ...
    iget-object v4, p1, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;

    iget-object v4, v4, Lcom/iap/ac/android/q7/n;->a:Ljava/lang/String;
    ...
    iget v4, v4, Lcom/iap/ac/android/q7/n;->c:I
    ...
    iget-object p1, p1, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;

    iget p1, p1, Lcom/iap/ac/android/q7/n;->d:I
    ...
    .line 12
    invoke-interface {v2, v3, v0}, Lcom/iap/ac/android/i7/k;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lio/fabric/sdk/android/services/network/HttpRequest;Lcom/iap/ac/android/q7/d;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 7

    const-string v0, "Failed to close app icon InputStream."

    .line 1
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->b:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->f:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->c:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->d:Ljava/lang/String;
    ...
    iget v1, p2, Lcom/iap/ac/android/q7/d;->g:I
    ...
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->h:Ljava/lang/String;
    ...
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->i:Ljava/lang/String;
    ...
    .line 8
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->e:Ljava/lang/String;

    invoke-static {v1}, Lcom/iap/ac/android/k7/i;->b(Ljava/lang/String;)Z
    ...
    .line 10
    :cond_0
    iget-object v1, p2, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;
    ...
    .line 11
    :try_start_0
    iget-object v2, p0, Lcom/iap/ac/android/k7/a;->kit:Lcom/iap/ac/android/i7/h;
    ...
    iget-object v3, p2, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;

    iget v3, v3, Lcom/iap/ac/android/q7/n;->b:I
    ...
    iget-object v3, v3, Lcom/iap/ac/android/q7/n;->a:Ljava/lang/String;
    ...
    iget v3, v3, Lcom/iap/ac/android/q7/n;->c:I
    ...
    iget v3, v3, Lcom/iap/ac/android/q7/n;->d:I
    ...
    iget-object v6, p2, Lcom/iap/ac/android/q7/d;->j:Lcom/iap/ac/android/q7/n;

    iget v6, v6, Lcom/iap/ac/android/q7/n;->b:I
    ...
    :cond_1
    :goto_2
    iget-object p2, p2, Lcom/iap/ac/android/q7/d;->k:Ljava/util/Collection;
    ...
    check-cast v0, Lcom/iap/ac/android/i7/j;

    .line 21
    invoke-virtual {p0, v0}, Lcom/iap/ac/android/q7/a;->b(Lcom/iap/ac/android/i7/j;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0}, Lcom/iap/ac/android/i7/j;->c()Ljava/lang/String;
    ...
    .line 22
    invoke-virtual {p0, v0}, Lcom/iap/ac/android/q7/a;->a(Lcom/iap/ac/android/i7/j;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0}, Lcom/iap/ac/android/i7/j;->a()Ljava/lang/String;
...
.method public b(Lcom/iap/ac/android/i7/j;)Ljava/lang/String;
    .locals 3
