.class public Lcom/iap/ac/android/fe/b;
...
.method public constructor <init>(Lcom/iap/ac/android/pd/h0;)V
    ...
    iput-object v0, p0, Lcom/iap/ac/android/fe/b;->y:Ljava/math/BigInteger;
    ...
    invoke-direct {p0, v0}, Lcom/iap/ac/android/fe/b;->isNotNull(Lcom/iap/ac/android/tc/f;)Z
    ...
    iput-object v0, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method public constructor <init>(Ljava/math/BigInteger;Ljava/security/spec/DSAParameterSpec;)V
    ...
    .line 11
    iput-object p1, p0, Lcom/iap/ac/android/fe/b;->y:Ljava/math/BigInteger;

    .line 12
    iput-object p2, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method public constructor <init>(Ljava/security/interfaces/DSAPublicKey;)V
    ...
    iput-object p1, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 3
    invoke-virtual {p0}, Lcom/iap/ac/android/fe/b;->getY()Ljava/math/BigInteger;
    ...
    .line 4
    invoke-virtual {p0}, Lcom/iap/ac/android/fe/b;->getParams()Ljava/security/interfaces/DSAParams;
...
.method public getEncoded()[B
    ...
    iget-object v2, p0, Lcom/iap/ac/android/fe/b;->y:Ljava/math/BigInteger;
    ...
    sget-object v2, Lcom/iap/ac/android/qd/o;->v2:Lcom/iap/ac/android/tc/n;

    new-instance v3, Lcom/iap/ac/android/pd/o;

    invoke-interface {v0}, Ljava/security/interfaces/DSAParams;->getP()Ljava/math/BigInteger;

    move-result-object v0

    iget-object v4, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v4}, Ljava/security/interfaces/DSAParams;->getQ()Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Lcom/iap/ac/android/fe/b;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v5}, Ljava/security/interfaces/DSAParams;->getG()Ljava/math/BigInteger;

    move-result-object v5

    invoke-direct {v3, v0, v4, v5}, Lcom/iap/ac/android/pd/o;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-virtual {v3}, Lcom/iap/ac/android/pd/o;->toASN1Primitive()Lcom/iap/ac/android/tc/r;

    move-result-object v0

    invoke-direct {v1, v2, v0}, Lcom/iap/ac/android/pd/a;-><init>(Lcom/iap/ac/android/tc/n;Lcom/iap/ac/android/tc/f;)V

    new-instance v0, Lcom/iap/ac/android/tc/k;

    iget-object v2, p0, Lcom/iap/ac/android/fe/b;->y:Ljava/math/BigInteger;

    invoke-direct {v0, v2}, Lcom/iap/ac/android/tc/k;-><init>(Ljava/math/BigInteger;)V

    invoke-static {v1, v0}, Lorg/spongycastle/jcajce/provider/asymmetric/util/KeyUtil;->getEncodedSubjectPublicKeyInfo(Lcom/iap/ac/android/pd/a;Lcom/iap/ac/android/tc/f;)[B
...
.method public getY()Ljava/math/BigInteger;
    ...
    .line 1
    iget-object v0, p0, Lcom/iap/ac/android/fe/b;->y:Ljava/math/BigInteger;
