...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcom/iap/ac/android/ub/h;Lcom/iap/ac/android/ub/g;)V
    .locals 2
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcom/iap/ac/android/ub/h;

    .line 7
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/iap/ac/android/ub/g;
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lcom/iap/ac/android/ub/h;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1Codec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Lcom/iap/ac/android/ub/h;->b(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lcom/iap/ac/android/ub/a0;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lcom/iap/ac/android/ub/a0;
    ...
    .line 3
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lcom/iap/ac/android/ub/a0;
...
.method public detachTimeout(Lcom/iap/ac/android/ub/l;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lcom/iap/ac/android/ub/l;->a()Lcom/iap/ac/android/ub/d0;

    move-result-object v0

    .line 2
    sget-object v1, Lcom/iap/ac/android/ub/d0;->NONE:Lcom/iap/ac/android/ub/d0;

    invoke-virtual {p1, v1}, Lcom/iap/ac/android/ub/l;->a(Lcom/iap/ac/android/ub/d0;)Lcom/iap/ac/android/ub/l;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/iap/ac/android/ub/g;
...
.method public newChunkedSink()Lcom/iap/ac/android/ub/a0;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lcom/iap/ac/android/ub/c0;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newFixedLengthSink(J)Lcom/iap/ac/android/ub/a0;
    .locals 2
...
.method public newFixedLengthSource(J)Lcom/iap/ac/android/ub/c0;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public newUnknownLengthSource()Lcom/iap/ac/android/ub/c0;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 4
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcom/iap/ac/android/ub/c0;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/iap/ac/android/ub/h;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lcom/iap/ac/android/ub/c0;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/iap/ac/android/ub/h;)V
    ...
    .line 10
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcom/iap/ac/android/ub/c0;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/iap/ac/android/ub/h;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lcom/iap/ac/android/ub/c0;
    ...
    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLcom/iap/ac/android/ub/h;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 4
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/iap/ac/android/ub/g;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 7
    invoke-interface {v2, v0}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 8
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lcom/iap/ac/android/ub/g;

    invoke-interface {p1, v0}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
