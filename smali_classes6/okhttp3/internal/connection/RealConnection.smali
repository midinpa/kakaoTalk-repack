...
.field public sink:Lcom/iap/ac/android/ub/g;

.field public socket:Ljava/net/Socket;

.field public source:Lcom/iap/ac/android/ub/h;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 31
    invoke-static {v1}, Lcom/iap/ac/android/ub/r;->b(Ljava/net/Socket;)Lcom/iap/ac/android/ub/c0;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcom/iap/ac/android/ub/h;Lcom/iap/ac/android/ub/g;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {v1}, Lcom/iap/ac/android/ub/c0;->timeout()Lcom/iap/ac/android/ub/d0;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lcom/iap/ac/android/ub/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcom/iap/ac/android/ub/d0;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lcom/iap/ac/android/ub/c0;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lcom/iap/ac/android/ub/c0;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 20
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {p1}, Lcom/iap/ac/android/ub/h;->buffer()Lcom/iap/ac/android/ub/f;

    move-result-object p1

    invoke-virtual {p1}, Lcom/iap/ac/android/ub/f;->s()Z

    move-result p1

    if-eqz p1, :cond_5

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lcom/iap/ac/android/ub/h;Lcom/iap/ac/android/ub/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {v2}, Lcom/iap/ac/android/ub/h;->s()Z
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    .line 4
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lcom/iap/ac/android/ub/h;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/iap/ac/android/ub/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcom/iap/ac/android/ub/d0;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lcom/iap/ac/android/ub/g;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lcom/iap/ac/android/ub/d0;->timeout(JLjava/util/concurrent/TimeUnit;)Lcom/iap/ac/android/ub/d0;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lcom/iap/ac/android/ub/h;Lcom/iap/ac/android/ub/g;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLcom/iap/ac/android/ub/h;Lcom/iap/ac/android/ub/g;Lokhttp3/internal/connection/StreamAllocation;)V
