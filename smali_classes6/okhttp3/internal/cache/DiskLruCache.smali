...
.field public journalWriter:Lcom/iap/ac/android/ub/g;
...
.method private newJournalWriter()Lcom/iap/ac/android/ub/g;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lcom/iap/ac/android/ub/a0;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lcom/iap/ac/android/ub/a0;)V
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lcom/iap/ac/android/ub/c0;
    ...
    .line 2
    :try_start_0
    invoke-interface {v1}, Lcom/iap/ac/android/ub/h;->m()Ljava/lang/String;
    ...
    .line 14
    invoke-interface {v1}, Lcom/iap/ac/android/ub/h;->s()Z
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lcom/iap/ac/android/ub/g;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;
...
.method public declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 25
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v3}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lcom/iap/ac/android/ub/g;)V

    .line 28
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;

    invoke-interface {p1, v2}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, p2}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
...
.method public declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p2, p1}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p2}, Lcom/iap/ac/android/ub/g;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lcom/iap/ac/android/ub/g;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
...
.method public declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lcom/iap/ac/android/ub/a0;
    ...
    invoke-interface {v0, v3, v4}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    .line 8
    invoke-interface {v0, v2}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    ...
    .line 11
    invoke-interface {v0, v4}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v4

    invoke-interface {v4, v5}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;

    .line 12
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 16
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lcom/iap/ac/android/ub/g;)V
...
.method public removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
