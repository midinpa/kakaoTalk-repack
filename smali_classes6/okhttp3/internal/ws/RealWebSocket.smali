...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Lcom/iap/ac/android/ub/i;->base64()Ljava/lang/String;
...
.method private declared-synchronized send(Lcom/iap/ac/android/ub/i;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILcom/iap/ac/android/ub/i;)V
...
.method public checkResponse(Lokhttp3/Response;)V
    ...
    .line 8
    invoke-virtual {v0}, Lcom/iap/ac/android/ub/i;->sha1()Lcom/iap/ac/android/ub/i;
...
.method public declared-synchronized close(ILjava/lang/String;J)Z
    ...
    .line 3
    invoke-static {p2}, Lcom/iap/ac/android/ub/i;->encodeUtf8(Ljava/lang/String;)Lcom/iap/ac/android/ub/i;
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILcom/iap/ac/android/ub/i;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 12
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lcom/iap/ac/android/ub/d0;

    move-result-object p1

    invoke-virtual {p1}, Lcom/iap/ac/android/ub/d0;->clearTimeout()Lcom/iap/ac/android/ub/d0;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lcom/iap/ac/android/ub/g;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLcom/iap/ac/android/ub/g;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lcom/iap/ac/android/ub/h;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLcom/iap/ac/android/ub/h;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lcom/iap/ac/android/ub/i;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lcom/iap/ac/android/ub/i;)V
...
.method public declared-synchronized onReadPing(Lcom/iap/ac/android/ub/i;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lcom/iap/ac/android/ub/i;)V
    .locals 0
...
.method public declared-synchronized pong(Lcom/iap/ac/android/ub/i;)Z
    .locals 1
...
.method public send(Lcom/iap/ac/android/ub/i;)Z
    .locals 1
    ...
    .line 3
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lcom/iap/ac/android/ub/i;I)Z
...
.method public writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lcom/iap/ac/android/ub/i;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lcom/iap/ac/android/ub/i;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lcom/iap/ac/android/ub/a0;
    ...
    .line 22
    invoke-interface {v0, v2}, Lcom/iap/ac/android/ub/g;->c(Lcom/iap/ac/android/ub/i;)Lcom/iap/ac/android/ub/g;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lcom/iap/ac/android/ub/i;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILcom/iap/ac/android/ub/i;)V
...
.method public writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lcom/iap/ac/android/ub/i;->EMPTY:Lcom/iap/ac/android/ub/i;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lcom/iap/ac/android/ub/i;)V
    :try_end_1
