...
.method public constructor <init>(Lcom/iap/ac/android/ub/h;Z)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lcom/iap/ac/android/ub/h;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILcom/iap/ac/android/ub/c0;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILcom/iap/ac/android/ub/h;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    int-to-long p2, v0

    invoke-interface {p1, p2, p3}, Lcom/iap/ac/android/ub/h;->skip(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {p4}, Lcom/iap/ac/android/ub/h;->readInt()I

    move-result p4

    .line 2
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {v2}, Lcom/iap/ac/android/ub/h;->readInt()I
    ...
    .line 4
    sget-object p3, Lcom/iap/ac/android/ub/i;->EMPTY:Lcom/iap/ac/android/ub/i;
    ...
    invoke-interface {p3, v1, v2}, Lcom/iap/ac/android/ub/h;->g(J)Lcom/iap/ac/android/ub/i;

    move-result-object p3

    .line 6
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lcom/iap/ac/android/ub/i;)V
...
.method public static readMedium(Lcom/iap/ac/android/ub/h;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0}, Lcom/iap/ac/android/ub/h;->readByte()B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {p2}, Lcom/iap/ac/android/ub/h;->readInt()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lcom/iap/ac/android/ub/h;

    invoke-interface {v1}, Lcom/iap/ac/android/ub/h;->readInt()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Lcom/iap/ac/android/ub/h;->readShort()S
    ...
    invoke-interface {v3}, Lcom/iap/ac/android/ub/h;->readInt()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lcom/iap/ac/android/ub/h;->d(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lcom/iap/ac/android/ub/h;)I
    ...
    invoke-interface {p1}, Lcom/iap/ac/android/ub/h;->readByte()B
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lcom/iap/ac/android/ub/i;
    ...
    invoke-interface {p1, v3, v4}, Lcom/iap/ac/android/ub/h;->g(J)Lcom/iap/ac/android/ub/i;
    ...
    invoke-virtual {v0, p1}, Lcom/iap/ac/android/ub/i;->equals(Ljava/lang/Object;)Z
