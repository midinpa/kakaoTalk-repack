...
# instance fields
.field public final boundary:Lcom/iap/ac/android/ub/i;
...
.method public constructor <init>(Lcom/iap/ac/android/ub/i;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Lcom/iap/ac/android/ub/i;
...
.method private writeOrCountBytes(Lcom/iap/ac/android/ub/g;Z)J
    .locals 12
    ...
    invoke-interface {p1, v8}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;

    .line 7
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundary:Lcom/iap/ac/android/ub/i;

    invoke-interface {p1, v8}, Lcom/iap/ac/android/ub/g;->c(Lcom/iap/ac/android/ub/i;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v10}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 11
    invoke-interface {v10, v11}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {v10, v11}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 15
    invoke-interface {p1, v8}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {v8, v7}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    .line 17
    invoke-interface {v7, v8}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;
    ...
    .line 19
    invoke-interface {p1, v9}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    .line 21
    invoke-interface {v9, v10}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v9}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;
    ...
    .line 24
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lcom/iap/ac/android/ub/g;)V

    .line 25
    :goto_4
    sget-object v6, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {p1, v6}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v1}, Lcom/iap/ac/android/ub/g;->write([B)Lcom/iap/ac/android/ub/g;

    .line 27
    iget-object v1, p0, Lokhttp3/MultipartBody;->boundary:Lcom/iap/ac/android/ub/i;

    invoke-interface {p1, v1}, Lcom/iap/ac/android/ub/g;->c(Lcom/iap/ac/android/ub/i;)Lcom/iap/ac/android/ub/g;
...
.method public boundary()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Lcom/iap/ac/android/ub/i;
...
.method public contentLength()J
    ...
    .line 2
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lcom/iap/ac/android/ub/g;Z)J
...
.method public writeTo(Lcom/iap/ac/android/ub/g;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lcom/iap/ac/android/ub/g;Z)J
