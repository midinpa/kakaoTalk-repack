...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/iap/ac/android/ub/i;->encodeUtf8(Ljava/lang/String;)Lcom/iap/ac/android/ub/i;

    move-result-object p0

    invoke-virtual {p0}, Lcom/iap/ac/android/ub/i;->md5()Lcom/iap/ac/android/ub/i;
...
.method public static readInt(Lcom/iap/ac/android/ub/h;)I
    .locals 5
    ...
    .line 1
    :try_start_0
    invoke-interface {p0}, Lcom/iap/ac/android/ub/h;->t()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Lcom/iap/ac/android/ub/h;->m()Ljava/lang/String;
...
.method public get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lcom/iap/ac/android/ub/c0;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lcom/iap/ac/android/ub/c0;)V
    :try_end_1
