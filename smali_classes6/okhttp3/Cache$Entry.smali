...
.method public constructor <init>(Lcom/iap/ac/android/ub/c0;)V
    ...
    .line 6
    invoke-static {v0}, Lokhttp3/Cache;->readInt(Lcom/iap/ac/android/ub/h;)I
    ...
    .line 30
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lcom/iap/ac/android/ub/h;)Ljava/util/List;
    ...
    .line 38
    :goto_4
    invoke-interface {p1}, Lcom/iap/ac/android/ub/c0;->close()V
...
.method private readCertificateList(Lcom/iap/ac/android/ub/h;)Ljava/util/List;
    .locals 6
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/Cache;->readInt(Lcom/iap/ac/android/ub/h;)I
    ...
    .line 5
    invoke-interface {p1}, Lcom/iap/ac/android/ub/h;->m()Ljava/lang/String;

    move-result-object v4

    .line 6
    new-instance v5, Lcom/iap/ac/android/ub/f;

    invoke-direct {v5}, Lcom/iap/ac/android/ub/f;-><init>()V

    .line 7
    invoke-static {v4}, Lcom/iap/ac/android/ub/i;->decodeBase64(Ljava/lang/String;)Lcom/iap/ac/android/ub/i;

    move-result-object v4

    invoke-virtual {v5, v4}, Lcom/iap/ac/android/ub/f;->c(Lcom/iap/ac/android/ub/i;)Lcom/iap/ac/android/ub/f;

    .line 8
    invoke-virtual {v5}, Lcom/iap/ac/android/ub/f;->A()Ljava/io/InputStream;
...
.method private writeCertList(Lcom/iap/ac/android/ub/g;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    .line 6
    invoke-interface {p1, v3}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v3

    .line 7
    invoke-interface {v3, v1}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    :try_end_0
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lcom/iap/ac/android/ub/a0;
    ...
    invoke-interface {p1, v3, v4}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v5}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v5

    .line 10
    invoke-interface {v5, v4}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {v4, v5}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v4

    .line 12
    invoke-interface {v4, v2}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {p1, v5, v6}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    .line 19
    invoke-interface {v3, v4}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;
    ...
    invoke-interface {v3, v5}, Lcom/iap/ac/android/ub/g;->c(Ljava/lang/String;)Lcom/iap/ac/android/ub/g;

    move-result-object v3

    .line 21
    invoke-interface {v3, v2}, Lcom/iap/ac/android/ub/g;->writeByte(I)Lcom/iap/ac/android/ub/g;
    ...
    .line 24
    invoke-interface {v0, v5, v6}, Lcom/iap/ac/android/ub/g;->e(J)Lcom/iap/ac/android/ub/g;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lcom/iap/ac/android/ub/g;Ljava/util/List;)V
