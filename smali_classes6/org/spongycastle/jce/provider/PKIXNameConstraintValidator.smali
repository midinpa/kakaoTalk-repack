...
.method private checkExcludedDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)V
    .locals 1
    ...
    .line 6
    invoke-static {p2, v0}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
...
.method private checkPermittedDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException;
...
.method public static compareTo([B[B)I
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/iap/ac/android/df/a;->a([B[B)Z
    ...
    invoke-static {p1, p0}, Lcom/iap/ac/android/df/a;->a([B[B)Z
...
.method private equals(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {p1, p2}, Lcom/iap/ac/android/df/a;->a([B[B)Z
...
.method private extractNameAsString(Lcom/iap/ac/android/pd/u;)Ljava/lang/String;
    .locals 0
    ...
    invoke-static {p1}, Lcom/iap/ac/android/tc/x0;->getInstance(Ljava/lang/Object;)Lcom/iap/ac/android/tc/x0;
...
.method private intersectDN(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    check-cast v1, Lcom/iap/ac/android/pd/w;

    invoke-virtual {v1}, Lcom/iap/ac/android/pd/w;->c()Lcom/iap/ac/android/pd/u;
    ...
    .line 9
    invoke-static {v1, v3}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
    ...
    .line 11
    :cond_3
    invoke-static {v3, v1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
...
.method private intersectDNS(Ljava/util/Set;Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 5
    invoke-direct {p0, v1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->extractNameAsString(Lcom/iap/ac/android/pd/u;)Ljava/lang/String;
...
.method private isIPConstrained([B[B)Z
    ...
    .line 9
    :cond_1
    invoke-static {v3, v4}, Lcom/iap/ac/android/df/a;->a([B[B)Z
...
.method private unionDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)Ljava/util/Set;
    .locals 3
    ...
    .line 7
    invoke-static {p2, v1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
    ...
    .line 9
    :cond_2
    invoke-static {v1, p2}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
...
.method public static withinDNSubtree(Lcom/iap/ac/android/tc/s;Lcom/iap/ac/android/tc/s;)Z
    .locals 5
    ...
    invoke-virtual {p0, v0}, Lcom/iap/ac/android/tc/s;->a(I)Lcom/iap/ac/android/tc/f;
...
.method private withinDomain(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 3
    invoke-static {p2, v0}, Lcom/iap/ac/android/df/l;->a(Ljava/lang/String;C)[Ljava/lang/String;

    move-result-object p2

    .line 4
    invoke-static {p1, v0}, Lcom/iap/ac/android/df/l;->a(Ljava/lang/String;C)[Ljava/lang/String;
...
# virtual methods
.method public addExcludedSubtree(Lcom/iap/ac/android/pd/w;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lcom/iap/ac/android/pd/w;->c()Lcom/iap/ac/android/pd/u;

    move-result-object p1

    .line 2
    invoke-virtual {p1}, Lcom/iap/ac/android/pd/u;->c()I
    ...
    .line 7
    invoke-direct {p0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->extractNameAsString(Lcom/iap/ac/android/pd/u;)Ljava/lang/String;
    ...
    .line 11
    invoke-direct {p0, v0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->unionDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)Ljava/util/Set;
...
.method public checkExcluded(Lcom/iap/ac/android/pd/u;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException;
    ...
    invoke-virtual {p0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->checkExcludedDN(Lcom/iap/ac/android/tc/s;)V
...
.method public checkExcludedDN(Lcom/iap/ac/android/tc/s;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException;
    ...
    invoke-direct {p0, v0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->checkExcludedDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)V

    return-void
.end method

.method public checkPermitted(Lcom/iap/ac/android/pd/u;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException;
    ...
    invoke-virtual {p0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->checkPermittedDN(Lcom/iap/ac/android/tc/s;)V
...
.method public checkPermittedDN(Lcom/iap/ac/android/tc/s;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException;
    ...
    invoke-direct {p0, v0, p1}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->checkPermittedDN(Ljava/util/Set;Lcom/iap/ac/android/tc/s;)V
...
.method public intersectPermittedSubtree(Lcom/iap/ac/android/pd/w;)V
    .locals 2

    const/4 v0, 0x1

    new-array v0, v0, [Lcom/iap/ac/android/pd/w;
    ...
    .line 1
    invoke-virtual {p0, v0}, Lorg/spongycastle/jce/provider/PKIXNameConstraintValidator;->intersectPermittedSubtree([Lcom/iap/ac/android/pd/w;)V
...
.method public intersectPermittedSubtree([Lcom/iap/ac/android/pd/w;)V
    ...
    .line 5
    invoke-virtual {v2}, Lcom/iap/ac/android/pd/w;->c()Lcom/iap/ac/android/pd/u;
