...
.method private readDERCrossCertificatePair(Ljava/io/InputStream;)Lcom/iap/ac/android/if/l;
    .locals 1
    ...
    .line 3
    invoke-static {p1}, Lcom/iap/ac/android/pd/n;->getInstance(Ljava/lang/Object;)Lcom/iap/ac/android/pd/n;

    move-result-object p1

    .line 4
    new-instance v0, Lcom/iap/ac/android/if/l;

    invoke-direct {v0, p1}, Lcom/iap/ac/android/if/l;-><init>(Lcom/iap/ac/android/pd/n;)V
...
.method public engineRead()Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/jce/provider/X509CertPairParser;->readDERCrossCertificatePair(Ljava/io/InputStream;)Lcom/iap/ac/android/if/l;
