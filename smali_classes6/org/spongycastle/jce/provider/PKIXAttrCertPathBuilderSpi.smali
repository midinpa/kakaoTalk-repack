...
.method private build(Lcom/iap/ac/android/if/h;Ljava/security/cert/X509Certificate;Lcom/iap/ac/android/ee/k;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    .line 2
    :cond_0
    invoke-virtual {p3}, Lcom/iap/ac/android/ee/k;->b()Ljava/util/Set;
    ...
    .line 3
    :cond_1
    invoke-virtual {p3}, Lcom/iap/ac/android/ee/k;->c()I
    ...
    .line 8
    :try_start_1
    invoke-virtual {p3}, Lcom/iap/ac/android/ee/k;->a()Lcom/iap/ac/android/ee/l;

    move-result-object v3

    invoke-virtual {v3}, Lcom/iap/ac/android/ee/l;->k()Ljava/util/Set;
    ...
    invoke-virtual {v4}, Lcom/iap/ac/android/ee/l;->i()Ljava/lang/String;

    move-result-object v4

    .line 10
    invoke-static {p2, v3, v4}, Lcom/iap/ac/android/se/b;->a(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-virtual {v1}, Lcom/iap/ac/android/ee/l;->d()Ljava/util/List;
    ...
    .line 20
    :try_start_5
    sget-object v1, Lcom/iap/ac/android/pd/s;->f:Lcom/iap/ac/android/tc/n;
    ...
    invoke-virtual {v3}, Lcom/iap/ac/android/ee/l;->h()Ljava/util/Map;

    move-result-object v3

    invoke-static {v1, v3}, Lcom/iap/ac/android/se/b;->a([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lcom/iap/ac/android/ee/l;->c()Ljava/util/List;

    move-result-object v3

    invoke-static {p2, v3, v0}, Lcom/iap/ac/android/se/b;->a(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 30
    :cond_4
    invoke-direct {p0, p1, v1, p3, p4}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(Lcom/iap/ac/android/if/h;Ljava/security/cert/X509Certificate;Lcom/iap/ac/android/ee/k;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public static findCertificates(Lcom/iap/ac/android/if/g;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    instance-of v1, p1, Lcom/iap/ac/android/if/c;

    if-nez v1, :cond_1

    instance-of v1, p1, Lcom/iap/ac/android/ee/k;
    ...
    const-class v1, Lcom/iap/ac/android/ee/k;
    ...
    .line 6
    new-instance v0, Lcom/iap/ac/android/ee/k$b;

    move-object v2, p1

    check-cast v2, Ljava/security/cert/PKIXBuilderParameters;

    invoke-direct {v0, v2}, Lcom/iap/ac/android/ee/k$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V

    .line 7
    instance-of v2, p1, Lcom/iap/ac/android/if/d;

    if-eqz v2, :cond_2

    .line 8
    check-cast p1, Lcom/iap/ac/android/if/c;

    .line 9
    invoke-virtual {p1}, Lcom/iap/ac/android/if/c;->i()Ljava/util/Set;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/iap/ac/android/ee/k$b;->a(Ljava/util/Set;)Lcom/iap/ac/android/ee/k$b;

    .line 10
    invoke-virtual {p1}, Lcom/iap/ac/android/if/c;->j()I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/iap/ac/android/ee/k$b;->a(I)Lcom/iap/ac/android/ee/k$b;

    .line 11
    invoke-virtual {p1}, Lcom/iap/ac/android/if/d;->e()Ljava/util/List;

    move-result-object v1

    .line 12
    :cond_2
    invoke-virtual {v0}, Lcom/iap/ac/android/ee/k$b;->a()Lcom/iap/ac/android/ee/k;
    ...
    .line 13
    :cond_3
    check-cast p1, Lcom/iap/ac/android/ee/k;
    ...
    .line 15
    invoke-virtual {p1}, Lcom/iap/ac/android/ee/k;->a()Lcom/iap/ac/android/ee/l;

    move-result-object v2

    invoke-virtual {v2}, Lcom/iap/ac/android/ee/l;->j()Lcom/iap/ac/android/ee/j;

    move-result-object v2

    .line 16
    instance-of v3, v2, Lcom/iap/ac/android/if/g;

    if-eqz v3, :cond_e

    .line 17
    :try_start_0
    check-cast v2, Lcom/iap/ac/android/if/g;

    invoke-static {v2, v1}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->findCertificates(Lcom/iap/ac/android/if/g;Ljava/util/List;)Ljava/util/Collection;
    ...
    check-cast v3, Lcom/iap/ac/android/if/h;
    ...
    .line 23
    invoke-interface {v3}, Lcom/iap/ac/android/if/h;->b()Lcom/iap/ac/android/if/b;

    move-result-object v5

    invoke-virtual {v5}, Lcom/iap/ac/android/if/b;->b()[Ljava/security/Principal;
    ...
    invoke-direct {v8, v4}, Lcom/iap/ac/android/ee/j$b;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    invoke-virtual {v9}, Lcom/iap/ac/android/ee/l;->c()Ljava/util/List;
    ...
    invoke-virtual {v9}, Lcom/iap/ac/android/ee/l;->d()Ljava/util/List;
    ...
    invoke-direct {p0, v3, v2, p1, v0}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->build(Lcom/iap/ac/android/if/h;Ljava/security/cert/X509Certificate;Lcom/iap/ac/android/ee/k;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    const-class v1, Lcom/iap/ac/android/if/g;
