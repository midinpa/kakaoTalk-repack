.class public Letri/fido/auth/crypto/SECP256K1;
.super Ljava/lang/Object;
.source "SECP256K1.java"


# static fields
.field public static final ECPublicKey_OID:Ljava/lang/String; = "1.2.840.10045.2.1"

.field public static final SECP256k1_OID:Ljava/lang/String; = "1.3.132.0.10"
...
.method public static getDEREncodedSignature([B)[B
    ...
    invoke-direct {v3, p0}, Lcom/iap/ac/android/tc/k;-><init>(Ljava/math/BigInteger;)V

    invoke-virtual {v1, v3}, Lcom/iap/ac/android/tc/g;->a(Lcom/iap/ac/android/tc/f;)V

    .line 8
    new-instance p0, Lcom/iap/ac/android/tc/k;

    invoke-direct {p0, v2}, Lcom/iap/ac/android/tc/k;-><init>(Ljava/math/BigInteger;)V

    invoke-virtual {v1, p0}, Lcom/iap/ac/android/tc/g;->a(Lcom/iap/ac/android/tc/f;)V

    .line 9
    :try_start_0
    new-instance p0, Lcom/iap/ac/android/tc/e1;

    invoke-direct {p0, v1}, Lcom/iap/ac/android/tc/e1;-><init>(Lcom/iap/ac/android/tc/g;)V

    const-string v1, "DER"

    invoke-virtual {p0, v1}, Lcom/iap/ac/android/tc/m;->getEncoded(Ljava/lang/String;)[B
...
.method public static main([Ljava/lang/String;)V
    ...
    .line 5
    invoke-static {v3, v4}, Letri/fido/auth/crypto/SECP256K1;->sign([BLjava/security/PrivateKey;)[B

    move-result-object v3

    .line 6
    invoke-static {v3}, Letri/fido/auth/crypto/SECP256K1;->getRawSignature([B)[B

    move-result-object v4

    .line 7
    invoke-static {v4}, Letri/fido/auth/crypto/SECP256K1;->getDEREncodedSignature([B)[B
    ...
    .line 10
    invoke-static {v0}, Letri/fido/auth/crypto/SECP256K1;->getRawPublicKey([B)[B

    move-result-object v0

    .line 11
    invoke-static {v0}, Letri/fido/auth/crypto/SECP256K1;->getPublicKeyfromRaw([B)Ljava/security/PublicKey;
    ...
    invoke-static {v1, v4, v0}, Letri/fido/auth/crypto/SECP256K1;->verify([B[BLjava/security/PublicKey;)Z
