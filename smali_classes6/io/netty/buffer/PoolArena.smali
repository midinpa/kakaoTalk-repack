...
# instance fields
.field public final activeBytesHuge:Lio/netty/util/internal/LongCounter;

.field public final allocationsHuge:Lio/netty/util/internal/LongCounter;

.field public allocationsNormal:J

.field public final allocationsSmall:Lio/netty/util/internal/LongCounter;

.field public final allocationsTiny:Lio/netty/util/internal/LongCounter;

.field public final chunkListMetrics:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field public final deallocationsHuge:Lio/netty/util/internal/LongCounter;

.field public deallocationsNormal:J

.field public deallocationsSmall:J

.field public deallocationsTiny:J

.field public final maxOrder:I
...
.field public final q000:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final q025:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/buffer/PoolChunkList<",
            "TT;>;"
...
.field public final q050:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/buffer/PoolChunkList<",
            "TT;>;"
...
.field public final q075:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/buffer/PoolChunkList<",
            "TT;>;"
...
.field public final q100:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/buffer/PoolChunkList<",
            "TT;>;"
...
.field public final qInit:Lio/netty/buffer/PoolChunkList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/buffer/PoolChunkList<",
            "TT;>;"
...
.field public final smallSubpagePools:[Lio/netty/buffer/PoolSubpage;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.field public final tinySubpagePools:[Lio/netty/buffer/PoolSubpage;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lio/netty/buffer/PoolSubpage<",
...
.method public constructor <init>(Lio/netty/buffer/PooledByteBufAllocator;IIII)V
    ...
    invoke-direct {p1, p2, v0, p4, p5}, Lio/netty/buffer/PoolChunkList;-><init>(Lio/netty/buffer/PoolChunkList;III)V
    ...
    invoke-direct {p1, p2, v1, p4, p5}, Lio/netty/buffer/PoolChunkList;-><init>(Lio/netty/buffer/PoolChunkList;III)V
    ...
    invoke-direct {p1, p2, p4, v0, p5}, Lio/netty/buffer/PoolChunkList;-><init>(Lio/netty/buffer/PoolChunkList;III)V
    ...
    invoke-direct {p1, p2, v0, v1, p5}, Lio/netty/buffer/PoolChunkList;-><init>(Lio/netty/buffer/PoolChunkList;III)V
    ...
    invoke-virtual {p1, p3}, Lio/netty/buffer/PoolChunkList;->prevList(Lio/netty/buffer/PoolChunkList;)V

    .line 32
    iget-object p1, p0, Lio/netty/buffer/PoolArena;->qInit:Lio/netty/buffer/PoolChunkList;

    invoke-virtual {p1, p1}, Lio/netty/buffer/PoolChunkList;->prevList(Lio/netty/buffer/PoolChunkList;)V
...
.method public static subPageMetricList([Lio/netty/buffer/PoolSubpage;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
