...
.field public static final FULL_EXCEPTION:Ljava/lang/IllegalStateException;

.field public static final POOL_KEY:Lio/netty/util/AttributeKey;
...
.field public static final UNHEALTHY_NON_OFFERED_TO_POOL:Ljava/lang/IllegalStateException;


# instance fields
.field public final bootstrap:Lio/netty/bootstrap/Bootstrap;
...
.field public final handler:Lio/netty/channel/pool/ChannelPoolHandler;

.field public final healthCheck:Lio/netty/channel/pool/ChannelHealthChecker;

.field public final releaseHealthCheck:Z
...
.method public static constructor <clinit>()V
    ...
    const-string v1, "Channel is unhealthy not offering it back to pool"

    invoke-direct {v0, v1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;)V

    sput-object v0, Lio/netty/channel/pool/SimpleChannelPool;->UNHEALTHY_NON_OFFERED_TO_POOL:Ljava/lang/IllegalStateException;
    ...
    .line 6
    sget-object v0, Lio/netty/channel/pool/SimpleChannelPool;->UNHEALTHY_NON_OFFERED_TO_POOL:Ljava/lang/IllegalStateException;
...
.method public static closeAndFail(Lio/netty/channel/Channel;Ljava/lang/Throwable;Lio/netty/util/concurrent/Promise;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static closeChannel(Lio/netty/channel/Channel;)V
    .locals 2
...
.method public static notifyConnect(Lio/netty/channel/ChannelFuture;Lio/netty/util/concurrent/Promise;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private releaseAndOfferIfHealthy(Lio/netty/channel/Channel;Lio/netty/util/concurrent/Promise;Lio/netty/util/concurrent/Future;)V
    ...
    .line 4
    sget-object p3, Lio/netty/channel/pool/SimpleChannelPool;->UNHEALTHY_NON_OFFERED_TO_POOL:Ljava/lang/IllegalStateException;

    invoke-static {p1, p3, p2}, Lio/netty/channel/pool/SimpleChannelPool;->closeAndFail(Lio/netty/channel/Channel;Ljava/lang/Throwable;Lio/netty/util/concurrent/Promise;)V
