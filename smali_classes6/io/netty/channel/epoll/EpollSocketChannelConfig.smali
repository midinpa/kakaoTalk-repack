...
# static fields
.field public static final MAX_UINT32_T:J = 0xffffffffL


# instance fields
.field public volatile allowHalfClosure:Z

.field public final channel:Lio/netty/channel/epoll/EpollSocketChannel;
...
.method public getTcpNotSentLowAt()J
    ...
    invoke-static {v0}, Lio/netty/channel/epoll/Native;->getTcpNotSentLowAt(I)I
...
.method public getTcpUserTimeout()I
    ...
    invoke-static {v0}, Lio/netty/channel/epoll/Native;->getTcpUserTimeout(I)I
...
.method public isTcpCork()Z
    ...
    invoke-virtual {v0}, Lio/netty/channel/unix/Socket;->isTcpCork()Z
...
.method public isTcpQuickAck()Z
    ...
    invoke-virtual {v0}, Lio/netty/channel/unix/Socket;->isTcpQuickAck()Z
...
.method public setTcpNotSentLowAt(J)Lio/netty/channel/epoll/EpollSocketChannelConfig;
    ...
    invoke-static {v0, p2}, Lio/netty/channel/epoll/Native;->setTcpNotSentLowAt(II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
