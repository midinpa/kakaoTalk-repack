...
.field public pipeIn:Lio/netty/channel/unix/FileDescriptor;

.field public pipeOut:Lio/netty/channel/unix/FileDescriptor;

.field public requestedRemoteAddress:Ljava/net/SocketAddress;

.field public spliceQueue:Ljava/util/Queue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Queue<",
            "Lio/netty/channel/epoll/AbstractEpollStreamChannel$SpliceInTask;",
...
.method public static safeClosePipe(Lio/netty/channel/unix/FileDescriptor;)V
    .locals 2
...
.method private shutdown0(Lio/netty/channel/ChannelPromise;)V
    ...
    invoke-virtual {v0, v1, v1}, Lio/netty/channel/unix/Socket;->shutdown(ZZ)V
...
.method private writeFileRegion(Lio/netty/channel/ChannelOutboundBuffer;Lio/netty/channel/DefaultFileRegion;I)Z
    ...
    invoke-static/range {v6 .. v13}, Lio/netty/channel/epoll/Native;->sendfile(ILio/netty/channel/DefaultFileRegion;JJJ)J
...
.method public doWriteSingle(Lio/netty/channel/ChannelOutboundBuffer;I)Z
    ...
    .line 8
    :cond_1
    instance-of p2, v0, Lio/netty/channel/epoll/AbstractEpollStreamChannel$SpliceOutTask;
...
.method public final spliceTo(Lio/netty/channel/epoll/AbstractEpollStreamChannel;ILio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    .line 6
    sget-object p1, Lio/netty/channel/epoll/AbstractEpollStreamChannel;->CLOSED_CHANNEL_EXCEPTION:Ljava/nio/channels/ClosedChannelException;
...
.method public final spliceTo(Lio/netty/channel/unix/FileDescriptor;IILio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    const-string p4, "offset must be >= 0 but was "
