...
.field public static final EMPTY_HANDLERS:[Lio/netty/channel/ChannelHandler;

.field public static final LOCAL_ADDRESS:Ljava/net/SocketAddress;

.field public static final METADATA_DISCONNECT:Lio/netty/channel/ChannelMetadata;

.field public static final METADATA_NO_DISCONNECT:Lio/netty/channel/ChannelMetadata;

.field public static final REMOTE_ADDRESS:Ljava/net/SocketAddress;
...
.field public inboundMessages:Ljava/util/Queue;
...
.field public lastException:Ljava/lang/Throwable;

.field public final loop:Lio/netty/channel/embedded/EmbeddedEventLoop;

.field public final metadata:Lio/netty/channel/ChannelMetadata;

.field public outboundMessages:Ljava/util/Queue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Queue<",
            "Ljava/lang/Object;",
...
.field public final recordExceptionListener:Lio/netty/channel/ChannelFutureListener;

.field public state:Lio/netty/channel/embedded/EmbeddedChannel$State;
...
.method public static isNotEmpty(Ljava/util/Queue;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static metadata(Z)Lio/netty/channel/ChannelMetadata;
    .locals 0
...
.method public static poll(Ljava/util/Queue;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static releaseAll(Ljava/util/Queue;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
