.class public final enum Lio/netty/channel/local/LocalChannel$State;
...
# static fields
.field public static final synthetic $VALUES:[Lio/netty/channel/local/LocalChannel$State;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Lio/netty/channel/local/LocalChannel$State;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v3, v2}, Lio/netty/channel/local/LocalChannel$State;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v4, v3}, Lio/netty/channel/local/LocalChannel$State;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v5, v4}, Lio/netty/channel/local/LocalChannel$State;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lio/netty/channel/local/LocalChannel$State;->CLOSED:Lio/netty/channel/local/LocalChannel$State;

    const/4 v5, 0x4

    new-array v5, v5, [Lio/netty/channel/local/LocalChannel$State;

    sget-object v6, Lio/netty/channel/local/LocalChannel$State;->OPEN:Lio/netty/channel/local/LocalChannel$State;
    ...
    sput-object v5, Lio/netty/channel/local/LocalChannel$State;->$VALUES:[Lio/netty/channel/local/LocalChannel$State;
