...
.field public static final FINISH_READ_FUTURE_UPDATER:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.field public static final MAX_READER_STACK_DEPTH:I = 0x8
...
.field public volatile connectPromise:Lio/netty/channel/ChannelPromise;

.field public volatile finishReadFuture:Lio/netty/util/concurrent/Future;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/util/concurrent/Future<",
            "*>;"
...
.field public volatile peer:Lio/netty/channel/local/LocalChannel;

.field public volatile readInProgress:Z

.field public final readTask:Ljava/lang/Runnable;

.field public volatile registerInProgress:Z

.field public volatile remoteAddress:Lio/netty/channel/local/LocalAddress;

.field public final shutdownHook:Ljava/lang/Runnable;

.field public volatile state:Lio/netty/channel/local/LocalChannel$State;

.field public volatile writeInProgress:Z
...
.method public static constructor <clinit>()V
    ...
    const-string v1, "finishReadFuture"
    ...
    .line 6
    sget-object v0, Lio/netty/channel/local/LocalChannel;->CLOSED_CHANNEL_EXCEPTION:Ljava/nio/channels/ClosedChannelException;
...
.method private doPeerClose(Lio/netty/channel/local/LocalChannel;Z)V
    ...
    invoke-interface {p2, p1}, Lio/netty/channel/Channel$Unsafe;->close(Lio/netty/channel/ChannelPromise;)V
...
.method public doWrite(Lio/netty/channel/ChannelOutboundBuffer;)V
    ...
    .line 13
    :cond_2
    sget-object p1, Lio/netty/channel/local/LocalChannel;->CLOSED_CHANNEL_EXCEPTION:Ljava/nio/channels/ClosedChannelException;
