...
.field public static final CHANNEL_CLOSED:Ljava/nio/channels/ClosedChannelException;

.field public static final HANDSHAKE_TIMED_OUT:Ljavax/net/ssl/SSLException;

.field public static final IGNORABLE_CLASS_IN_STACK:Ljava/util/regex/Pattern;

.field public static final IGNORABLE_ERROR_MESSAGE:Ljava/util/regex/Pattern;

.field public static final SSLENGINE_CLOSED:Ljavax/net/ssl/SSLException;

.field public static final logger:Lio/netty/util/internal/logging/InternalLogger;


# instance fields
.field public volatile closeNotifyTimeoutMillis:J

.field public volatile ctx:Lio/netty/channel/ChannelHandlerContext;

.field public final delegatedTaskExecutor:Ljava/util/concurrent/Executor;

.field public final engine:Ljavax/net/ssl/SSLEngine;

.field public firedChannelRead:Z

.field public flushedBeforeHandshake:Z

.field public handshakePromise:Lio/netty/util/concurrent/Promise;
...
.field public volatile handshakeTimeoutMillis:J

.field public final maxPacketBufferSize:I

.field public needsFlush:Z

.field public outboundClosed:Z

.field public packetLength:I

.field public pendingUnencryptedWrites:Lio/netty/channel/PendingWriteQueue;

.field public readDuringHandshake:Z

.field public sentFirstMessage:Z

.field public final singleBuffer:[Ljava/nio/ByteBuffer;

.field public final sslCloseFuture:Lio/netty/handler/ssl/SslHandler$LazyChannelPromise;

.field public final startTls:Z

.field public final wantsDirectBuffer:Z

.field public final wantsLargeOutboundNetworkBuffer:Z
...
.method public static toByteBuffer(Lio/netty/buffer/ByteBuf;II)Ljava/nio/ByteBuffer;
    .locals 2
...
.method private unwrap(Ljavax/net/ssl/SSLEngine;Lio/netty/buffer/ByteBuf;IILio/netty/buffer/ByteBuf;)Ljavax/net/ssl/SSLEngineResult;
    ...
    invoke-static {p5, v1, p3}, Lio/netty/handler/ssl/SslHandler;->toByteBuffer(Lio/netty/buffer/ByteBuf;II)Ljava/nio/ByteBuffer;
...
.method private wrap(Lio/netty/channel/ChannelHandlerContext;Z)V
    ...
    invoke-direct {p0, v0, v3, v2, v4}, Lio/netty/handler/ssl/SslHandler;->wrap(Lio/netty/buffer/ByteBufAllocator;Ljavax/net/ssl/SSLEngine;Lio/netty/buffer/ByteBuf;Lio/netty/buffer/ByteBuf;)Ljavax/net/ssl/SSLEngineResult;
...
.method public applicationProtocol()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/netty/handler/ssl/ApplicationProtocolAccessor;->getApplicationProtocol()Ljava/lang/String;
...
.method public handlerRemoved0(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-virtual {p1}, Lio/netty/handler/ssl/OpenSslEngine;->shutdown()V
