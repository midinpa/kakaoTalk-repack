...
.field public static final DESTROYED_UPDATER:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.field public static final EMPTY_ADDR:J

.field public static final EMPTY_CERTIFICATES:[Ljava/security/cert/Certificate;

.field public static final EMPTY_X509_CERTIFICATES:[Ljavax/security/cert/X509Certificate;

.field public static final ENCRYPTED_PACKET_OVERSIZED:Ljavax/net/ssl/SSLException;

.field public static final ENGINE_CLOSED:Ljavax/net/ssl/SSLException;

.field public static final INVALID_CIPHER:Ljava/lang/String; = "SSL_NULL_WITH_NULL_NULL"

.field public static final MAX_CIPHERTEXT_LENGTH:I = 0x4800

.field public static final MAX_COMPRESSED_LENGTH:I = 0x4400
...
.field public static final MAX_PLAINTEXT_LENGTH:I = 0x4000
...
.field public static final PROTOCOL_SSL_V2:Ljava/lang/String; = "SSLv2"

.field public static final PROTOCOL_SSL_V2_HELLO:Ljava/lang/String; = "SSLv2Hello"

.field public static final PROTOCOL_SSL_V3:Ljava/lang/String; = "SSLv3"

.field public static final PROTOCOL_TLS_V1:Ljava/lang/String; = "TLSv1"

.field public static final PROTOCOL_TLS_V1_1:Ljava/lang/String; = "TLSv1.1"

.field public static final PROTOCOL_TLS_V1_2:Ljava/lang/String; = "TLSv1.2"

.field public static final RENEGOTIATION_UNSUPPORTED:Ljavax/net/ssl/SSLException;
...
# instance fields
.field public volatile algorithmConstraints:Ljava/lang/Object;

.field public final alloc:Lio/netty/buffer/ByteBufAllocator;

.field public final apn:Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;

.field public volatile clientAuth:Lio/netty/handler/ssl/ClientAuth;

.field public final clientMode:Z

.field public volatile destroyed:I

.field public volatile endPointIdentificationAlgorithm:Ljava/lang/String;

.field public engineClosed:Z
...
.field public handshakeState:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;

.field public isInboundDone:Z

.field public isOutboundDone:Z

.field public final localCerts:[Ljava/security/cert/Certificate;

.field public networkBIO:J

.field public receivedShutdown:Z

.field public final rejectRemoteInitiatedRenegation:Z

.field public final session:Lio/netty/handler/ssl/OpenSslEngine$OpenSslSession;
...
.method public static constructor <clinit>()V
    ...
    sget-object v1, Lio/netty/handler/ssl/OpenSslEngine;->SUPPORTED_PROTOCOLS:[Ljava/lang/String;
    ...
    sput-object v0, Lio/netty/handler/ssl/OpenSslEngine;->SUPPORTED_PROTOCOLS_SET:Ljava/util/Set;
...
.method public constructor <init>(JLio/netty/buffer/ByteBufAllocator;ZLio/netty/handler/ssl/OpenSslSessionContext;Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;Lio/netty/handler/ssl/OpenSslEngineMap;ZLjava/lang/String;I[Ljava/security/cert/Certificate;Lio/netty/handler/ssl/ClientAuth;)V
    ...
    new-array v0, p10, [Ljava/nio/ByteBuffer;

    .line 6
    iput-object v0, p0, Lio/netty/handler/ssl/OpenSslEngine;->singleSrcBuffer:[Ljava/nio/ByteBuffer;

    new-array p10, p10, [Ljava/nio/ByteBuffer;

    .line 7
    iput-object p10, p0, Lio/netty/handler/ssl/OpenSslEngine;->singleDstBuffer:[Ljava/nio/ByteBuffer;
    ...
    const-string p10, "alloc"

    .line 9
    invoke-static {p3, p10}, Lio/netty/util/internal/ObjectUtil;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, p9}, Lorg/apache/tomcat/jni/SSL;->setTlsExtHostName(JLjava/lang/String;)V
...
.method private handshake()Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;
    ...
    invoke-virtual {v0}, Lio/netty/handler/ssl/OpenSslEngine$OpenSslSession;->handshakeFinished()V
...
.method private readEncryptedData(Ljava/nio/ByteBuffer;I)I
    ...
    .line 11
    invoke-virtual {v0, v2, p1}, Lio/netty/buffer/ByteBuf;->getBytes(ILjava/nio/ByteBuffer;)Lio/netty/buffer/ByteBuf;
...
.method private resetSingleDstBuffer()V
    ...
    .line 1
    iget-object v0, p0, Lio/netty/handler/ssl/OpenSslEngine;->singleDstBuffer:[Ljava/nio/ByteBuffer;
...
.method private resetSingleSrcBuffer()V
    ...
    .line 1
    iget-object v0, p0, Lio/netty/handler/ssl/OpenSslEngine;->singleSrcBuffer:[Ljava/nio/ByteBuffer;
...
.method private shutdownWithError(Ljava/lang/String;Ljava/lang/String;)Ljavax/net/ssl/SSLException;
    ...
    .line 6
    iget-object p1, p0, Lio/netty/handler/ssl/OpenSslEngine;->handshakeState:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;

    sget-object v0, Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;->FINISHED:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
...
.method public static toJavaCipherSuitePrefix(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
...
.method public getSSLParameters()Ljavax/net/ssl/SSLParameters;
    ...
    .line 4
    iget-object v1, p0, Lio/netty/handler/ssl/OpenSslEngine;->algorithmConstraints:Ljava/lang/Object;

    invoke-static {v0, v1}, Lio/netty/handler/ssl/SslParametersUtils;->setAlgorithmConstraints(Ljavax/net/ssl/SSLParameters;Ljava/lang/Object;)V
...
.method public declared-synchronized unwrap([Ljava/nio/ByteBuffer;II[Ljava/nio/ByteBuffer;II)Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 12
    iget-object v6, v1, Lio/netty/handler/ssl/OpenSslEngine;->handshakeState:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;

    sget-object v12, Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;->STARTED_EXPLICITLY:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
    ...
    .line 28
    :cond_d
    invoke-direct {v1, v2}, Lio/netty/handler/ssl/OpenSslEngine;->readPlaintextData(Ljava/nio/ByteBuffer;)I
    ...
    :cond_f
    :try_start_4
    iget-wide v2, v1, Lio/netty/handler/ssl/OpenSslEngine;->ssl:J

    invoke-static {v2, v3, v7}, Lorg/apache/tomcat/jni/SSL;->getError(JI)I
    ...
    sget-wide v4, Lio/netty/handler/ssl/OpenSslEngine;->EMPTY_ADDR:J

    invoke-static {v2, v3, v4, v5, v8}, Lorg/apache/tomcat/jni/SSL;->readFromSSL(JJI)I
    ...
    .line 40
    invoke-direct {v1, v2, v9, v8}, Lio/netty/handler/ssl/OpenSslEngine;->sslReadErrorResult(III)Ljavax/net/ssl/SSLEngineResult;
    ...
    :cond_15
    :try_start_8
    iget-boolean v2, v1, Lio/netty/handler/ssl/OpenSslEngine;->receivedShutdown:Z
...
.method public declared-synchronized wrap([Ljava/nio/ByteBuffer;IILjava/nio/ByteBuffer;)Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 7
    iget-object p3, p0, Lio/netty/handler/ssl/OpenSslEngine;->handshakeState:Lio/netty/handler/ssl/OpenSslEngine$HandshakeState;
