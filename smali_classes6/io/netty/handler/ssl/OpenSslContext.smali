...
# static fields
.field public static final BEGIN_CERT:[B

.field public static final BEGIN_PRIVATE_KEY:[B
...
.field public static final END_CERT:[B

.field public static final END_PRIVATE_KEY:[B

.field public static final JDK_REJECT_CLIENT_INITIATED_RENEGOTIATION:Z
...
.field public volatile aprPoolDestroyed:I
...
.field public volatile rejectRemoteInitiatedRenegotiation:Z

.field public final sessionCacheSize:J

.field public final sessionTimeout:J

.field public final unmodifiableCiphers:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/netty/handler/ssl/OpenSslContext;->BEGIN_CERT:[B
    ...
    sput-object v0, Lio/netty/handler/ssl/OpenSslContext;->END_CERT:[B
    ...
    sput-object v0, Lio/netty/handler/ssl/OpenSslContext;->BEGIN_PRIVATE_KEY:[B
    ...
    sput-boolean v0, Lio/netty/handler/ssl/OpenSslContext;->JDK_REJECT_CLIENT_INITIATED_RENEGOTIATION:Z

    .line 7
    new-instance v0, Lio/netty/handler/ssl/OpenSslContext$1;

    invoke-direct {v0}, Lio/netty/handler/ssl/OpenSslContext$1;-><init>()V

    sput-object v0, Lio/netty/handler/ssl/OpenSslContext;->NONE_PROTOCOL_NEGOTIATOR:Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;
    ...
    const-string v5, "AES128-SHA"

    const-string v6, "AES256-SHA"

    const-string v7, "DES-CBC3-SHA"
    ...
    sput-object v1, Lio/netty/handler/ssl/OpenSslContext;->DEFAULT_CIPHERS:Ljava/util/List;

    .line 11
    sget-object v1, Lio/netty/handler/ssl/OpenSslContext;->logger:Lio/netty/util/internal/logging/InternalLogger;
...
.method public constructor <init>(Ljava/lang/Iterable;Lio/netty/handler/ssl/CipherSuiteFilter;Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;JJI[Ljava/security/cert/Certificate;Lio/netty/handler/ssl/ClientAuth;)V
    ...
    iput-wide p9, p0, Lio/netty/handler/ssl/OpenSslContext;->aprPool:J

    .line 17
    :try_start_0
    const-class p9, Lio/netty/handler/ssl/OpenSslContext;
    ...
    invoke-static {v1, v2, p10, p8}, Lorg/apache/tomcat/jni/SSLContext;->make(JII)J
    ...
    iget-object p8, p0, Lio/netty/handler/ssl/OpenSslContext;->unmodifiableCiphers:Ljava/util/List;

    invoke-static {p8}, Lio/netty/handler/ssl/CipherSuiteConverter;->toOpenSsl(Ljava/lang/Iterable;)Ljava/lang/String;

    move-result-object p8

    invoke-static {v1, v2, p8}, Lorg/apache/tomcat/jni/SSLContext;->setCipherSuite(JLjava/lang/String;)Z
    :try_end_3
    ...
    invoke-interface {p8, v1}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-static {v1}, Lio/netty/handler/ssl/OpenSslContext;->opensslSelectorFailureBehavior(Lio/netty/handler/ssl/ApplicationProtocolConfig$SelectorFailureBehavior;)I

    move-result v1

    .line 32
    sget-object v2, Lio/netty/handler/ssl/OpenSslContext$2;->$SwitchMap$io$netty$handler$ssl$ApplicationProtocolConfig$Protocol:[I
    ...
    .line 33
    iget-wide v2, p0, Lio/netty/handler/ssl/OpenSslContext;->ctx:J

    invoke-static {v2, v3, p8, v1}, Lorg/apache/tomcat/jni/SSLContext;->setNpnProtos(J[Ljava/lang/String;I)V

    .line 34
    iget-wide v2, p0, Lio/netty/handler/ssl/OpenSslContext;->ctx:J

    invoke-static {v2, v3, p8, v1}, Lorg/apache/tomcat/jni/SSLContext;->setAlpnProtos(J[Ljava/lang/String;I)V
    ...
    .line 43
    iget-wide p1, p0, Lio/netty/handler/ssl/OpenSslContext;->ctx:J
    ...
    iput-wide p1, p0, Lio/netty/handler/ssl/OpenSslContext;->sessionTimeout:J
    ...
    iget-object p4, p0, Lio/netty/handler/ssl/OpenSslContext;->unmodifiableCiphers:Ljava/util/List;
...
.method public static newBIO(Lio/netty/buffer/ByteBuf;)J
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static opensslSelectorFailureBehavior(Lio/netty/handler/ssl/ApplicationProtocolConfig$SelectorFailureBehavior;)I
    .locals 2
...
.method public final newEngine(Lio/netty/buffer/ByteBufAllocator;Ljava/lang/String;I)Ljavax/net/ssl/SSLEngine;
    ...
    .line 1
    new-instance v14, Lio/netty/handler/ssl/OpenSslEngine;

    iget-wide v2, v0, Lio/netty/handler/ssl/OpenSslContext;->ctx:J
    ...
    iget-object v7, v0, Lio/netty/handler/ssl/OpenSslContext;->apn:Lio/netty/handler/ssl/OpenSslApplicationProtocolNegotiator;

    iget-object v8, v0, Lio/netty/handler/ssl/OpenSslContext;->engineMap:Lio/netty/handler/ssl/OpenSslEngineMap;

    iget-boolean v9, v0, Lio/netty/handler/ssl/OpenSslContext;->rejectRemoteInitiatedRenegotiation:Z

    iget-object v12, v0, Lio/netty/handler/ssl/OpenSslContext;->keyCertChain:[Ljava/security/cert/Certificate;

    iget-object v13, v0, Lio/netty/handler/ssl/OpenSslContext;->clientAuth:Lio/netty/handler/ssl/ClientAuth;
