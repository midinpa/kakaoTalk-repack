.class public final Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultEndpoint;
...
# instance fields
.field public flowController:Lio/netty/handler/codec/http2/Http2FlowController;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TF;"
        }
...
.field public lastStreamKnownByPeer:I

.field public maxActiveStreams:I

.field public nextReservationStreamId:I

.field public nextStreamIdToCreate:I

.field public numActiveStreams:I

.field public pushToAllowed:Z
...
.method private checkNewStreamAllowed(ILio/netty/handler/codec/http2/Http2Stream$State;)V
    ...
    iget-object p1, p1, Lio/netty/handler/codec/http2/DefaultHttp2Connection;->localEndpoint:Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultEndpoint;

    invoke-virtual {p1}, Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultEndpoint;->lastStreamKnownByPeer()I
    ...
    const-string p1, "Cannot create stream %d since this endpoint has received a GOAWAY frame with last stream id %d."
...
.method public canOpenStream()Z
    ...
    iget v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultEndpoint;->maxActiveStreams:I
...
.method public createStream(IZ)Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultStream;
    ...
    .line 7
    invoke-virtual {p1}, Lio/netty/handler/codec/http2/DefaultHttp2Connection$DefaultStream;->activate()V
