.class public final Lio/netty/handler/codec/http2/Http2MultiplexCodec$ConnectionListener;
...
.method private onStreamClosed0(Lio/netty/handler/codec/http2/Http2MultiplexCodec$StreamInfo;)V
    ...
    iput-boolean v0, p1, Lio/netty/handler/codec/http2/Http2MultiplexCodec$Http2StreamChannel;->onStreamClosedFired:Z

    .line 2
    sget-object v0, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;->CLOSE_MESSAGE:Ljava/lang/Object;

    invoke-virtual {p1, v0}, Lio/netty/handler/codec/http2/AbstractHttp2StreamChannel;->fireChildRead(Ljava/lang/Object;)V
...
.method public onGoAwayReceived(IJLio/netty/buffer/ByteBuf;)V
    ...
    .line 7
    :goto_0
    iget-object p1, p0, Lio/netty/handler/codec/http2/Http2MultiplexCodec$ConnectionListener;->this$0:Lio/netty/handler/codec/http2/Http2MultiplexCodec;
...
.method public onStreamActive(Lio/netty/handler/codec/http2/Http2Stream;)V
    ...
    .line 4
    iget-object v1, p0, Lio/netty/handler/codec/http2/Http2MultiplexCodec$ConnectionListener;->this$0:Lio/netty/handler/codec/http2/Http2MultiplexCodec;
    ...
    new-instance v2, Lio/netty/handler/codec/http2/Http2MultiplexCodec$StreamInfo;
    ...
    invoke-direct {v2, v0}, Lio/netty/handler/codec/http2/Http2MultiplexCodec$StreamInfo;-><init>(Lio/netty/handler/codec/http2/Http2MultiplexCodec$Http2StreamChannel;)V
