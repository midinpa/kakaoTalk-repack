...
# instance fields
.field public minAllocationChunk:I
...
.field public totalStreamableBytes:J
...
.method public minAllocationChunk(I)V
    ...
    const-string v0, "minAllocationChunk must be > 0"
...
.method public streamableBytes0(Lio/netty/handler/codec/http2/Http2Stream;)I
    ...
    iget p1, p1, Lio/netty/handler/codec/http2/UniformStreamByteDistributor$State;->streamableBytes:I
