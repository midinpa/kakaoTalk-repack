.class public final Lio/netty/handler/codec/http2/Http2MultiplexCodec$Http2StreamChannel;
...
.method private bytesConsumed0(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->exceptionCaught(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)V
...
.method public doWrite(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, v1}, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->writeFromStreamChannel(Ljava/lang/Object;Z)V
    ...
    const-string v0, "Stream must be null on the frame"
    ...
    const-string v2, "Message must be an Http2StreamFrame: "
...
.method public doWriteComplete()V
    ...
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->flushFromStreamChannel()V
