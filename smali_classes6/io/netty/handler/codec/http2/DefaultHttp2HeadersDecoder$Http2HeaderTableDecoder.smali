.class public final Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder$Http2HeaderTableDecoder;
...
# direct methods
.method public constructor <init>(Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;)V
    .locals 0
...
.method public maxHeaderTableSize()I
    ...
    invoke-static {v0}, Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;->access$100(Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;)Lio/netty/handler/codec/http2/internal/hpack/Decoder;

    move-result-object v0

    invoke-virtual {v0}, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->getMaxHeaderTableSize()I
...
.method public maxHeaderTableSize(I)V
    ...
    .line 1
    :try_start_0
    iget-object v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder$Http2HeaderTableDecoder;->this$0:Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;

    invoke-static {v2}, Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;->access$100(Lio/netty/handler/codec/http2/DefaultHttp2HeadersDecoder;)Lio/netty/handler/codec/http2/internal/hpack/Decoder;

    move-result-object v2

    invoke-virtual {v2, p1}, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->setMaxHeaderTableSize(I)V
    :try_end_0
    ...
    invoke-static {v2, p1, v1}, Lio/netty/handler/codec/http2/Http2Exception;->connectionError(Lio/netty/handler/codec/http2/Http2Error;Ljava/lang/String;[Ljava/lang/Object;)Lio/netty/handler/codec/http2/Http2Exception;
