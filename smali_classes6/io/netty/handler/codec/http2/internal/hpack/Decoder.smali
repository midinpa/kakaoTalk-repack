...
# static fields
.field public static final DECOMPRESSION_EXCEPTION:Ljava/io/IOException;

.field public static final ILLEGAL_INDEX_VALUE:Ljava/io/IOException;

.field public static final INVALID_MAX_DYNAMIC_TABLE_SIZE:Ljava/io/IOException;

.field public static final MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED:Ljava/io/IOException;


# instance fields
.field public final dynamicTable:Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;

.field public encoderMaxDynamicTableSize:I

.field public headerSize:J

.field public huffmanEncoded:Z

.field public index:I

.field public indexType:Lio/netty/handler/codec/http2/internal/hpack/HpackUtil$IndexType;

.field public maxDynamicTableSize:I

.field public maxDynamicTableSizeChangeRequired:Z
...
.field public skipLength:I

.field public state:Lio/netty/handler/codec/http2/internal/hpack/Decoder$State;
...
.method public static constructor <clinit>()V
    ...
    const-string v1, "HPACK - illegal index value"

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    sput-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->ILLEGAL_INDEX_VALUE:Ljava/io/IOException;

    .line 3
    new-instance v0, Ljava/io/IOException;

    const-string v1, "HPACK - invalid max dynamic table size"

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    sput-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->INVALID_MAX_DYNAMIC_TABLE_SIZE:Ljava/io/IOException;

    .line 4
    new-instance v0, Ljava/io/IOException;

    const-string v1, "HPACK - max dynamic table size change required"

    invoke-direct {v0, v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    sput-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED:Ljava/io/IOException;

    .line 5
    sget-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->DECOMPRESSION_EXCEPTION:Ljava/io/IOException;

    sget-object v1, Lio/netty/util/internal/EmptyArrays;->EMPTY_STACK_TRACE:[Ljava/lang/StackTraceElement;

    invoke-virtual {v0, v1}, Ljava/io/IOException;->setStackTrace([Ljava/lang/StackTraceElement;)V

    .line 6
    sget-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->ILLEGAL_INDEX_VALUE:Ljava/io/IOException;
    ...
    .line 7
    sget-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->INVALID_MAX_DYNAMIC_TABLE_SIZE:Ljava/io/IOException;
    ...
    .line 8
    sget-object v0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED:Ljava/io/IOException;
...
.method public static decodeULE128(Ljava/io/InputStream;)I
    .locals 4
...
.method private indexHeader(ILio/netty/handler/codec/http2/internal/hpack/HeaderListener;)V
    ...
    invoke-virtual {v0, p1}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->getEntry(I)Lio/netty/handler/codec/http2/internal/hpack/HeaderField;
    ...
    .line 7
    :cond_1
    sget-object p1, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->ILLEGAL_INDEX_VALUE:Ljava/io/IOException;
...
.method private insertHeader(Lio/netty/handler/codec/http2/internal/hpack/HeaderListener;[B[BLio/netty/handler/codec/http2/internal/hpack/HpackUtil$IndexType;)V
    ...
    .line 3
    iget-object p1, p0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->dynamicTable:Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;

    new-instance p4, Lio/netty/handler/codec/http2/internal/hpack/HeaderField;

    invoke-direct {p4, p2, p3}, Lio/netty/handler/codec/http2/internal/hpack/HeaderField;-><init>([B[B)V

    invoke-virtual {p1, p4}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->add(Lio/netty/handler/codec/http2/internal/hpack/HeaderField;)V
...
.method private readName(I)V
    ...
    invoke-virtual {v1}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->length()I
    ...
    sget v1, Lio/netty/handler/codec/http2/internal/hpack/StaticTable;->length:I
...
.method private readStringLiteral(Ljava/io/InputStream;I)[B
    ...
    .line 3
    iget-boolean p1, p0, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->huffmanEncoded:Z

    if-eqz p1, :cond_0

    .line 4
    sget-object p1, Lio/netty/handler/codec/http2/internal/hpack/Huffman;->DECODER:Lio/netty/handler/codec/http2/internal/hpack/HuffmanDecoder;

    invoke-virtual {p1, v0}, Lio/netty/handler/codec/http2/internal/hpack/HuffmanDecoder;->decode([B)[B
    ...
    .line 5
    :cond_1
    sget-object p1, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->DECOMPRESSION_EXCEPTION:Ljava/io/IOException;
...
.method private setDynamicTableSize(I)V
    ...
    invoke-virtual {v0, p1}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->setCapacity(I)V

    return-void

    .line 5
    :cond_0
    sget-object p1, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->INVALID_MAX_DYNAMIC_TABLE_SIZE:Ljava/io/IOException;
...
.method public decode(Ljava/io/InputStream;Lio/netty/handler/codec/http2/internal/hpack/HeaderListener;)V
    ...
    .line 93
    :cond_1a
    sget-object p1, Lio/netty/handler/codec/http2/internal/hpack/Decoder;->MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED:Ljava/io/IOException;
...
.method public length()I
    ...
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->length()I
...
.method public size()I
    ...
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/internal/hpack/DynamicTable;->size()I
