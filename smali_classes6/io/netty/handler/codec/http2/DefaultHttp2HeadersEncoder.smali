...
# instance fields
.field public final encoder:Lio/netty/handler/codec/http2/internal/hpack/Encoder;

.field public final headerTable:Lio/netty/handler/codec/http2/Http2HeaderTable;

.field public final sensitivityDetector:Lio/netty/handler/codec/http2/Http2HeadersEncoder$SensitivityDetector;

.field public final tableSizeChangeOutput:Ljava/io/ByteArrayOutputStream;
...
.method private encodeHeader(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/io/OutputStream;)V
    ...
    iget-object v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2HeadersEncoder;->sensitivityDetector:Lio/netty/handler/codec/http2/Http2HeadersEncoder$SensitivityDetector;

    invoke-interface {v3, p1, p2}, Lio/netty/handler/codec/http2/Http2HeadersEncoder$SensitivityDetector;->isSensitive(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z

    move-result p1

    invoke-virtual {v0, p3, v1, v2, p1}, Lio/netty/handler/codec/http2/internal/hpack/Encoder;->encodeHeader(Ljava/io/OutputStream;[B[BZ)V
...
.method private toBytes(Ljava/lang/CharSequence;)[B
    ...
    .line 2
    invoke-virtual {p1}, Lio/netty/util/AsciiString;->isEntireArrayUsed()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lio/netty/util/AsciiString;->toByteArray()[B
