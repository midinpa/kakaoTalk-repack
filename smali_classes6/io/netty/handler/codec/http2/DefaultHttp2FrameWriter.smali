...
# static fields
.field public static final STREAM_DEPENDENCY:Ljava/lang/String; = "Stream Dependency"

.field public static final STREAM_ID:Ljava/lang/String; = "Stream ID"

.field public static final ZERO_BUFFER:Lio/netty/buffer/ByteBuf;


# instance fields
.field public final headersEncoder:Lio/netty/handler/codec/http2/Http2HeadersEncoder;
...
.method public static verifyErrorCode(J)V
    .locals 3
...
.method public static verifyPingPayload(Lio/netty/buffer/ByteBuf;)V
    .locals 1
...
.method public static verifyStreamId(ILjava/lang/String;)V
    .locals 1
...
.method public static verifyWeight(S)V
    .locals 3
...
.method public static verifyWindowSizeIncrement(I)V
    .locals 1
...
.method private writeContinuationFrames(Lio/netty/channel/ChannelHandlerContext;ILio/netty/buffer/ByteBuf;ILio/netty/handler/codec/http2/Http2CodecUtil$SimpleChannelPromiseAggregator;)Lio/netty/channel/ChannelFuture;
    ...
    .line 11
    invoke-virtual {v14, v10}, Lio/netty/buffer/ByteBuf;->readRetainedSlice(I)Lio/netty/buffer/ByteBuf;
    ...
    invoke-interface {v1, v10, v7}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;

    goto :goto_1

    .line 14
    :cond_3
    invoke-virtual {v5, v6}, Lio/netty/handler/codec/http2/Http2Flags;->endOfHeaders(Z)Lio/netty/handler/codec/http2/Http2Flags;
    ...
    invoke-interface {v7, v12}, Lio/netty/buffer/ByteBufAllocator;->buffer(I)Lio/netty/buffer/ByteBuf;

    move-result-object v7

    .line 17
    invoke-static {v7, v10, v13, v5, v2}, Lio/netty/handler/codec/http2/Http2CodecUtil;->writeFrameHeaderInternal(Lio/netty/buffer/ByteBuf;IBLio/netty/handler/codec/http2/Http2Flags;I)V

    .line 18
    invoke-static {v7, v3}, Lio/netty/handler/codec/http2/DefaultHttp2FrameWriter;->writePaddingLength(Lio/netty/buffer/ByteBuf;I)V
    ...
    invoke-interface {v1, v7, v10}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {v1, v15, v7}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-virtual {v7, v10, v3}, Lio/netty/buffer/ByteBuf;->slice(II)Lio/netty/buffer/ByteBuf;
    ...
    invoke-interface {v1, v7, v15}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
...
.method private writeHeadersInternal(Lio/netty/channel/ChannelHandlerContext;ILio/netty/handler/codec/http2/Http2Headers;IZZISZLio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-interface {v0, v4, v5}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
...
.method public static writePaddingLength(Lio/netty/buffer/ByteBuf;I)V
    .locals 0
...
.method public writeData(Lio/netty/channel/ChannelHandlerContext;ILio/netty/buffer/ByteBuf;IZLio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-direct {v4, v0, v2}, Lio/netty/handler/codec/http2/DefaultHttp2FrameWriter$DataFrameHeader;-><init>(Lio/netty/channel/ChannelHandlerContext;I)V
    ...
    :goto_0
    :try_start_1
    iget v9, v1, Lio/netty/handler/codec/http2/DefaultHttp2FrameWriter;->maxFrameSize:I
    ...
    invoke-interface {v0, v7, v14}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    :try_end_2
    ...
    invoke-interface {v0, v7, v9}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
...
.method public writeGoAway(Lio/netty/channel/ChannelHandlerContext;IJLio/netty/buffer/ByteBuf;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    :try_start_0
    const-string v2, "Last Stream ID"

    .line 2
    invoke-static {p2, v2}, Lio/netty/handler/codec/http2/DefaultHttp2FrameWriter;->verifyStreamOrConnectionId(ILjava/lang/String;)V
    ...
    invoke-static {v3, v2, v4, v5, p6}, Lio/netty/handler/codec/http2/Http2CodecUtil;->writeFrameHeaderInternal(Lio/netty/buffer/ByteBuf;IBLio/netty/handler/codec/http2/Http2Flags;I)V

    .line 7
    invoke-virtual {v3, p2}, Lio/netty/buffer/ByteBuf;->writeInt(I)Lio/netty/buffer/ByteBuf;

    .line 8
    invoke-static {p3, p4, v3}, Lio/netty/handler/codec/http2/Http2CodecUtil;->writeUnsignedInt(JLio/netty/buffer/ByteBuf;)V
    ...
    invoke-interface {p1, v3, p2}, Lio/netty/channel/ChannelOutboundInvoker;->write(Ljava/lang/Object;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    :try_end_0
...
.method public writePing(Lio/netty/channel/ChannelHandlerContext;ZLio/netty/buffer/ByteBuf;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-virtual {p2, v1}, Lio/netty/handler/codec/http2/Http2Flags;->ack(Z)Lio/netty/handler/codec/http2/Http2Flags;
    ...
    invoke-static {v2, v3, v4, p2, p4}, Lio/netty/handler/codec/http2/Http2CodecUtil;->writeFrameHeaderInternal(Lio/netty/buffer/ByteBuf;IBLio/netty/handler/codec/http2/Http2Flags;I)V
