...
# static fields
.field public static final HTTP2_FRAME_LOGGER:Lio/netty/handler/codec/http2/Http2FrameLogger;


# instance fields
.field public ctx:Lio/netty/channel/ChannelHandlerContext;

.field public volatile flushTask:Ljava/lang/Runnable;

.field public final http2Handler:Lio/netty/handler/codec/http2/Http2ConnectionHandler;

.field public http2HandlerCtx:Lio/netty/channel/ChannelHandlerContext;

.field public final streamGroup:Lio/netty/channel/EventLoopGroup;

.field public final streamHandler:Lio/netty/channel/ChannelHandler;

.field public final streamInfoKey:Lio/netty/handler/codec/http2/Http2Connection$PropertyKey;

.field public final streamsToFireChildReadComplete:Ljava/util/List;
...
.method public constructor <init>(ZLio/netty/channel/ChannelHandler;Lio/netty/channel/EventLoopGroup;Lio/netty/handler/codec/http2/Http2FrameWriter;)V
    ...
    .line 10
    new-instance p3, Lio/netty/handler/codec/http2/DefaultHttp2ConnectionEncoder;

    invoke-direct {p3, p2, p1}, Lio/netty/handler/codec/http2/DefaultHttp2ConnectionEncoder;-><init>(Lio/netty/handler/codec/http2/Http2Connection;Lio/netty/handler/codec/http2/Http2FrameWriter;)V

    .line 11
    new-instance p1, Lio/netty/handler/codec/http2/Http2InboundFrameLogger;

    new-instance p4, Lio/netty/handler/codec/http2/DefaultHttp2FrameReader;

    invoke-direct {p4}, Lio/netty/handler/codec/http2/DefaultHttp2FrameReader;-><init>()V

    sget-object v0, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->HTTP2_FRAME_LOGGER:Lio/netty/handler/codec/http2/Http2FrameLogger;

    invoke-direct {p1, p4, v0}, Lio/netty/handler/codec/http2/Http2InboundFrameLogger;-><init>(Lio/netty/handler/codec/http2/Http2FrameReader;Lio/netty/handler/codec/http2/Http2FrameLogger;)V

    .line 12
    new-instance p4, Lio/netty/handler/codec/http2/DefaultHttp2ConnectionDecoder;

    invoke-direct {p4, p2, p3, p1}, Lio/netty/handler/codec/http2/DefaultHttp2ConnectionDecoder;-><init>(Lio/netty/handler/codec/http2/Http2Connection;Lio/netty/handler/codec/http2/Http2ConnectionEncoder;Lio/netty/handler/codec/http2/Http2FrameReader;)V
    ...
    invoke-interface {p4, p1}, Lio/netty/handler/codec/http2/Http2ConnectionDecoder;->frameListener(Lio/netty/handler/codec/http2/Http2FrameListener;)V
    ...
    new-instance p2, Lio/netty/handler/codec/http2/Http2MultiplexCodec$ConnectionListener;

    invoke-direct {p2, p0}, Lio/netty/handler/codec/http2/Http2MultiplexCodec$ConnectionListener;-><init>(Lio/netty/handler/codec/http2/Http2MultiplexCodec;)V
    ...
    .line 16
    iget-object p1, p0, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->http2Handler:Lio/netty/handler/codec/http2/Http2ConnectionHandler;
    ...
    const-string p2, "streamHandler must be Sharable"
...
.method public channelReadComplete(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    .line 5
    :cond_0
    iget-object p1, p0, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->streamsToFireChildReadComplete:Ljava/util/List;
...
.method public fireChildReadAndRegister(Lio/netty/handler/codec/http2/Http2MultiplexCodec$StreamInfo;Ljava/lang/Object;)V
    ...
    .line 3
    iget-object p2, p0, Lio/netty/handler/codec/http2/Http2MultiplexCodec;->streamsToFireChildReadComplete:Ljava/util/List;
    ...
    .line 4
    iput-boolean p2, p1, Lio/netty/handler/codec/http2/Http2MultiplexCodec$StreamInfo;->inStreamsToFireChildReadComplete:Z
...
.method public userEventTriggered(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    invoke-interface {v2}, Lio/netty/handler/codec/http2/Http2ConnectionDecoder;->frameListener()Lio/netty/handler/codec/http2/Http2FrameListener;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Lio/netty/handler/codec/http2/InboundHttpToHttp2Adapter;-><init>(Lio/netty/handler/codec/http2/Http2Connection;Lio/netty/handler/codec/http2/Http2FrameListener;)V
    ...
    invoke-virtual {v0, p1, v1}, Lio/netty/handler/codec/http2/InboundHttpToHttp2Adapter;->channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
