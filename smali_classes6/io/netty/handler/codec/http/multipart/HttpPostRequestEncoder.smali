...
# static fields
.field public static final percentEncodings:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
# instance fields
.field public final bodyListDatas:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field public currentBuffer:Lio/netty/buffer/ByteBuf;

.field public currentData:Lio/netty/handler/codec/http/multipart/InterfaceHttpData;

.field public currentFileUpload:Lio/netty/handler/codec/http/multipart/FileUpload;

.field public duringMixedMode:Z

.field public final encoderMode:Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder$EncoderMode;

.field public final factory:Lio/netty/handler/codec/http/multipart/HttpDataFactory;

.field public globalBodySize:J

.field public globalProgress:J

.field public headerFinalized:Z
...
.field public isLastChunkSent:Z
...
.method public constructor <init>(Lio/netty/handler/codec/http/multipart/HttpDataFactory;Lio/netty/handler/codec/http/HttpRequest;ZLjava/nio/charset/Charset;Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder$EncoderMode;)V
    ...
    .line 17
    iget-boolean p1, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->isMultipart:Z
...
.method public static getNewMultipartDelimiter()Ljava/lang/String;
    .locals 2
...
.method public finalizeRequest()Lio/netty/handler/codec/http/HttpRequest;
    ...
    iget-object v3, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->request:Lio/netty/handler/codec/http/HttpRequest;

    invoke-direct {v2, v3, v0, v1}, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder$WrappedFullHttpRequest;-><init>(Lio/netty/handler/codec/http/HttpRequest;Lio/netty/handler/codec/http/HttpContent;Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder$1;)V
