...
# static fields
.field public static final DEFAULT_ERRORS:[Ljava/lang/String;

.field public static final DEFAULT_SIMPLE_STRINGS:[Ljava/lang/String;

.field public static final INSTANCE:Lio/netty/handler/codec/redis/FixedRedisMessagePool;

.field public static final MAX_CACHED_INTEGER_NUMBER:J = 0x80L

.field public static final MIN_CACHED_INTEGER_NUMBER:J = -0x1L

.field public static final SIZE_CACHED_INTEGER_NUMBER:I = 0x81


# instance fields
.field public byteBufToErrors:Ljava/util/Map;
...
.field public byteBufToIntegers:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lio/netty/buffer/ByteBuf;",
...
.field public byteBufToSimpleStrings:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lio/netty/buffer/ByteBuf;",
...
.field public longToByteBufs:Lio/netty/util/collection/LongObjectMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public longToIntegers:Lio/netty/util/collection/LongObjectMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/netty/util/collection/LongObjectMap<",
            "Lio/netty/handler/codec/redis/IntegerRedisMessage;",
...
.field public stringToErrors:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field public stringToSimpleStrings:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.method public constructor <init>()V
    ...
    .line 4
    sget-object v0, Lio/netty/handler/codec/redis/FixedRedisMessagePool;->DEFAULT_SIMPLE_STRINGS:[Ljava/lang/String;
    ...
    .line 11
    sget-object v0, Lio/netty/handler/codec/redis/FixedRedisMessagePool;->DEFAULT_ERRORS:[Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2}, Lio/netty/util/collection/LongObjectHashMap;-><init>(IF)V
