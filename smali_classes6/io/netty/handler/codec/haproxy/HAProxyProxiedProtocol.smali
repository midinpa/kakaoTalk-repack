...
# static fields
.field public static final synthetic $VALUES:[Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
...
# instance fields
.field public final addressFamily:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$AddressFamily;

.field public final byteValue:B

.field public final transportProtocol:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;
...
.method public static constructor <clinit>()V
    ...
    sget-object v6, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->STREAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;

    const-string v2, "TCP6"
    ...
    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->TCP6:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
    ...
    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UDP4:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
    ...
    sget-object v6, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->DGRAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;

    const-string v2, "UDP6"
    ...
    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UDP6:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
    ...
    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UNIX_STREAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    .line 7
    new-instance v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    sget-object v5, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$AddressFamily;->AF_UNIX:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$AddressFamily;

    sget-object v6, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->DGRAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;

    const-string v2, "UNIX_DGRAM"
    ...
    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UNIX_DGRAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    const/4 v1, 0x7

    new-array v1, v1, [Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
    ...
    sget-object v2, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->TCP4:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    const/4 v3, 0x1

    aput-object v2, v1, v3

    sget-object v2, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->TCP6:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    const/4 v3, 0x2

    aput-object v2, v1, v3

    sget-object v2, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UDP4:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    const/4 v3, 0x3

    aput-object v2, v1, v3

    sget-object v2, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UDP6:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    const/4 v3, 0x4

    aput-object v2, v1, v3

    sget-object v2, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->UNIX_STREAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;
    ...
    sput-object v1, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;->$VALUES:[Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;IBLio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$AddressFamily;Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(B",
