...
# static fields
.field public static final synthetic $VALUES:[Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1, v1}, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;-><init>(Ljava/lang/String;IB)V
    ...
    invoke-direct {v0, v3, v2, v2}, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;-><init>(Ljava/lang/String;IB)V

    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->STREAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;
    ...
    const-string v4, "DGRAM"

    invoke-direct {v0, v4, v3, v3}, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;-><init>(Ljava/lang/String;IB)V

    sput-object v0, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->DGRAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;

    const/4 v4, 0x3

    new-array v4, v4, [Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;
    ...
    sget-object v1, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->STREAM:Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;

    aput-object v1, v4, v2

    aput-object v0, v4, v3

    sput-object v4, Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;->$VALUES:[Lio/netty/handler/codec/haproxy/HAProxyProxiedProtocol$TransportProtocol;
