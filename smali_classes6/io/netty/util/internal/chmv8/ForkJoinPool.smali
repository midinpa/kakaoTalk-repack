...
.field public static final AC_MASK:J = -0x1000000000000L

.field public static final AC_SHIFT:I = 0x30

.field public static final AC_UNIT:J = 0x1000000000000L

.field public static final ASHIFT:I

.field public static final CTL:J

.field public static final EC_SHIFT:I = 0x10

.field public static final EVENMASK:I = 0xfffe

.field public static final E_MASK:I = 0x7fffffff

.field public static final E_SEQ:I = 0x10000

.field public static final FAST_IDLE_TIMEOUT:J = 0xbebc200L

.field public static final FIFO_QUEUE:I = 0x1

.field public static final IDLE_TIMEOUT:J = 0x77359400L

.field public static final INDEXSEED:J

.field public static final INT_SIGN:I = -0x80000000

.field public static final LIFO_QUEUE:I = 0x0

.field public static final MAX_CAP:I = 0x7fff

.field public static final MAX_HELP:I = 0x40

.field public static final PARKBLOCKER:J

.field public static final PLOCK:J

.field public static final PL_LOCK:I = 0x2

.field public static final PL_SIGNAL:I = 0x1

.field public static final PL_SPINS:I = 0x100

.field public static final QBASE:J

.field public static final QLOCK:J

.field public static final SEED_INCREMENT:I = 0x61c88647

.field public static final SHARED_QUEUE:I = -0x1

.field public static final SHORT_SIGN:I = 0x8000

.field public static final SHUTDOWN:I = -0x80000000

.field public static final SMASK:I = 0xffff

.field public static final SQMASK:I = 0x7e

.field public static final STEALCOUNT:J

.field public static final STOP_BIT:J = 0x80000000L

.field public static final ST_SHIFT:I = 0x1f
...
.field public static final TIMEOUT_SLOP:J = 0x1e8480L

.field public static final U:Lsun/misc/Unsafe;

.field public static final UAC_MASK:I = -0x10000

.field public static final UAC_SHIFT:I = 0x10

.field public static final UAC_UNIT:I = 0x10000

.field public static final UTC_MASK:I = 0xffff

.field public static final UTC_SHIFT:I = 0x0

.field public static final UTC_UNIT:I = 0x1
...
.method public constructor <init>(ILio/netty/util/internal/chmv8/ForkJoinPool$ForkJoinWorkerThreadFactory;Ljava/lang/Thread$UncaughtExceptionHandler;ILjava/lang/String;)V
    .locals 2
...
.method private final awaitWork(Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;JI)I
    ...
    .line 13
    iget v7, v9, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->eventCount:I

    if-ne v7, v0, :cond_7

    iget-wide v11, v3, Lio/netty/util/internal/chmv8/ForkJoinPool;->ctl:J
    ...
    invoke-virtual {v0, v7, v1, v2}, Lsun/misc/Unsafe;->park(ZJ)V
    ...
    sget-wide v6, Lio/netty/util/internal/chmv8/ForkJoinPool;->CTL:J
...
.method public static checkFactory(Lio/netty/util/internal/chmv8/ForkJoinPool$ForkJoinWorkerThreadFactory;)Lio/netty/util/internal/chmv8/ForkJoinPool$ForkJoinWorkerThreadFactory;
    .locals 0
...
.method public static checkParallelism(I)I
    .locals 1
...
.method private fullExternalPush(Lio/netty/util/internal/chmv8/ForkJoinTask;)V
    ...
    .line 11
    iget v4, v3, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->top:I
    ...
    iget v10, v3, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->base:I
    ...
    invoke-virtual {v6, v2, v10, v11, v14}, Lsun/misc/Unsafe;->putOrderedObject(Ljava/lang/Object;JLjava/lang/Object;)V

    add-int/lit8 v4, v4, 0x1

    .line 15
    iput v4, v3, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->top:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 16
    :goto_3
    iput v8, v3, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->qlock:I

    if-eqz v9, :cond_0

    .line 17
    invoke-virtual {v7, v1, v3}, Lio/netty/util/internal/chmv8/ForkJoinPool;->signalWork([Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;)V
    ...
    invoke-direct {v9, v7, v2, v1, v10}, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;-><init>(Lio/netty/util/internal/chmv8/ForkJoinPool;Lio/netty/util/internal/chmv8/ForkJoinWorkerThread;II)V
    ...
    .line 27
    invoke-direct {v7, v9}, Lio/netty/util/internal/chmv8/ForkJoinPool;->releasePlock(I)V
    ...
    .line 33
    iput-object v9, v7, Lio/netty/util/internal/chmv8/ForkJoinPool;->workQueues:[Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;
...
.method public static makeCommonPool()Lio/netty/util/internal/chmv8/ForkJoinPool;
    .locals 9
...
.method private tryHelpStealer(Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;Lio/netty/util/internal/chmv8/ForkJoinTask;)I
    ...
    .line 12
    iget v10, v6, Lio/netty/util/internal/chmv8/ForkJoinTask;->status:I

    if-ltz v10, :cond_0

    iget-object v10, v5, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->currentJoin:Lio/netty/util/internal/chmv8/ForkJoinTask;
...
.method private tryTerminate(ZZ)Z
    ...
    .line 12
    iget-short v3, v9, Lio/netty/util/internal/chmv8/ForkJoinPool;->parallelism:S
...
.method public final deregisterWorker(Lio/netty/util/internal/chmv8/ForkJoinWorkerThread;Ljava/lang/Throwable;)V
    ...
    .line 18
    iget-object v1, v9, Lio/netty/util/internal/chmv8/ForkJoinPool;->workQueues:[Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;
    ...
    .line 19
    :cond_8
    iget v1, v13, Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;->nextWait:I
...
.method public final helpQuiescePool(Lio/netty/util/internal/chmv8/ForkJoinPool$WorkQueue;)V
    ...
    .line 10
    iget-short v0, v8, Lio/netty/util/internal/chmv8/ForkJoinPool;->parallelism:S
