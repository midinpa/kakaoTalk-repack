...
.field public static final DECODER:Lio/netty/handler/codec/dns/DatagramDnsResponseDecoder;

.field public static final DEFAULT_RESOLVE_ADDRESS_TYPES:[Lio/netty/channel/socket/InternetProtocolFamily;

.field public static final ENCODER:Lio/netty/handler/codec/dns/DatagramDnsQueryEncoder;
...
.field public final hostsFileEntriesResolver:Lio/netty/resolver/HostsFileEntriesResolver;

.field public final maxPayloadSize:I

.field public final maxQueriesPerResolve:I

.field public final nameServerAddrStream:Lio/netty/util/concurrent/FastThreadLocal;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lio/netty/resolver/dns/DnsNameResolver;->ANY_LOCAL_ADDR:Ljava/net/InetSocketAddress;
    ...
    .line 4
    sput-object v0, Lio/netty/resolver/dns/DnsNameResolver;->DEFAULT_RESOLVE_ADDRESS_TYPES:[Lio/netty/channel/socket/InternetProtocolFamily;
...
.method public constructor <init>(Lio/netty/channel/EventLoop;Lio/netty/channel/ChannelFactory;Ljava/net/InetSocketAddress;Lio/netty/resolver/dns/DnsServerAddresses;Lio/netty/resolver/dns/DnsCache;J[Lio/netty/channel/socket/InternetProtocolFamily;ZIZIZLio/netty/resolver/HostsFileEntriesResolver;)V
    ...
    new-instance p2, Lio/netty/channel/FixedRecvByteBufAllocator;

    invoke-direct {p2, p12}, Lio/netty/channel/FixedRecvByteBufAllocator;-><init>(I)V

    invoke-interface {p1, p2}, Lio/netty/channel/socket/DatagramChannelConfig;->setRecvByteBufAllocator(Lio/netty/channel/RecvByteBufAllocator;)Lio/netty/channel/socket/DatagramChannelConfig;
...
.method public static cast(Lio/netty/util/concurrent/Promise;)Lio/netty/util/concurrent/Promise;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private doResolveAllCached(Ljava/lang/String;Lio/netty/util/concurrent/Promise;Lio/netty/resolver/dns/DnsCache;)Z
    ...
    check-cast v0, Lio/netty/resolver/dns/DnsCacheEntry;

    invoke-virtual {v0}, Lio/netty/resolver/dns/DnsCacheEntry;->cause()Ljava/lang/Throwable;
    ...
    .line 6
    :cond_1
    iget-object v1, p0, Lio/netty/resolver/dns/DnsNameResolver;->resolvedAddressTypes:[Lio/netty/channel/socket/InternetProtocolFamily;
    ...
    check-cast v8, Lio/netty/resolver/dns/DnsCacheEntry;

    .line 8
    invoke-virtual {v6}, Lio/netty/channel/socket/InternetProtocolFamily;->addressType()Ljava/lang/Class;

    move-result-object v9

    invoke-virtual {v8}, Lio/netty/resolver/dns/DnsCacheEntry;->address()Ljava/net/InetAddress;
...
.method private doResolveCached(Ljava/lang/String;Lio/netty/util/concurrent/Promise;Lio/netty/resolver/dns/DnsCache;)Z
    ...
    invoke-interface {p1, p3, p2, v0}, Lio/netty/util/internal/logging/InternalLogger;->warn(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public static hostname(Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private query0(Ljava/net/InetSocketAddress;Lio/netty/handler/codec/dns/DnsQuestion;Ljava/lang/Iterable;Lio/netty/util/concurrent/Promise;)Lio/netty/util/concurrent/Future;
    ...
    .line 3
    invoke-interface {p4, p1}, Lio/netty/util/concurrent/Promise;->setFailure(Ljava/lang/Throwable;)Lio/netty/util/concurrent/Promise;
...
.method private resolveHostsFileEntry(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-interface {v0, p1}, Lio/netty/resolver/HostsFileEntriesResolver;->address(Ljava/lang/String;)Ljava/net/InetAddress;
...
.method public static setSuccess(Lio/netty/util/concurrent/Promise;Ljava/net/InetAddress;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public isTraceEnabled()Z
    ...
    .line 1
    iget-boolean v0, p0, Lio/netty/resolver/dns/DnsNameResolver;->traceEnabled:Z
...
.method public resolveAddressTypesUnsafe()[Lio/netty/channel/socket/InternetProtocolFamily;
    ...
    .line 1
    iget-object v0, p0, Lio/netty/resolver/dns/DnsNameResolver;->resolvedAddressTypes:[Lio/netty/channel/socket/InternetProtocolFamily;
