...
# instance fields
.field public final channelFactory:Lio/netty/channel/ChannelFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final localAddress:Ljava/net/InetSocketAddress;

.field public final nameServerAddresses:Lio/netty/resolver/dns/DnsServerAddresses;

.field public final resolveAllsInProgress:Ljava/util/concurrent/ConcurrentMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final resolvesInProgress:Ljava/util/concurrent/ConcurrentMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/ConcurrentMap<",
            "Ljava/lang/String;",
...
.method public newNameResolver(Lio/netty/channel/EventLoop;Lio/netty/channel/ChannelFactory;Ljava/net/InetSocketAddress;Lio/netty/resolver/dns/DnsServerAddresses;)Lio/netty/resolver/NameResolver;
    ...
    invoke-direct {v0, p1}, Lio/netty/resolver/dns/DnsNameResolverBuilder;-><init>(Lio/netty/channel/EventLoop;)V

    invoke-virtual {v0, p2}, Lio/netty/resolver/dns/DnsNameResolverBuilder;->channelFactory(Lio/netty/channel/ChannelFactory;)Lio/netty/resolver/dns/DnsNameResolverBuilder;

    move-result-object p1

    invoke-virtual {p1, p3}, Lio/netty/resolver/dns/DnsNameResolverBuilder;->localAddress(Ljava/net/InetSocketAddress;)Lio/netty/resolver/dns/DnsNameResolverBuilder;

    move-result-object p1

    invoke-virtual {p1, p4}, Lio/netty/resolver/dns/DnsNameResolverBuilder;->nameServerAddresses(Lio/netty/resolver/dns/DnsServerAddresses;)Lio/netty/resolver/dns/DnsNameResolverBuilder;
...
.method public newResolver(Lio/netty/channel/EventLoop;Lio/netty/channel/ChannelFactory;Ljava/net/InetSocketAddress;Lio/netty/resolver/dns/DnsServerAddresses;)Lio/netty/resolver/AddressResolver;
    ...
    iget-object p4, p0, Lio/netty/resolver/dns/DnsAddressResolverGroup;->resolveAllsInProgress:Ljava/util/concurrent/ConcurrentMap;

    invoke-direct {v0, p1, p2, p3, p4}, Lio/netty/resolver/dns/InflightNameResolver;-><init>(Lio/netty/util/concurrent/EventExecutor;Lio/netty/resolver/NameResolver;Ljava/util/concurrent/ConcurrentMap;Ljava/util/concurrent/ConcurrentMap;)V

    .line 5
    new-instance p2, Lio/netty/resolver/InetSocketAddressResolver;

    invoke-direct {p2, p1, v0}, Lio/netty/resolver/InetSocketAddressResolver;-><init>(Lio/netty/util/concurrent/EventExecutor;Lio/netty/resolver/NameResolver;)V
