.class public abstract Lio/netty/resolver/dns/DnsNameResolverContext;
...
.field public static final INADDRSZ4:I = 0x4

.field public static final INADDRSZ6:I = 0x10

.field public static final RELEASE_RESPONSE:Lio/netty/util/concurrent/FutureListener;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# instance fields
.field public allowedQueries:I

.field public final hostname:Ljava/lang/String;

.field public final maxAllowedQueries:I

.field public final nameServerAddrs:Lio/netty/resolver/dns/DnsServerAddressStream;

.field public final parent:Lio/netty/resolver/dns/DnsNameResolver;
...
.field public final queriesInProgress:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.field public final resolveAddressTypes:[Lio/netty/channel/socket/InternetProtocolFamily;

.field public final resolveCache:Lio/netty/resolver/dns/DnsCache;

.field public resolvedEntries:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field public final traceEnabled:Z

.field public triedCNAME:Z
...
.method public constructor <init>(Lio/netty/resolver/dns/DnsNameResolver;Ljava/lang/String;Lio/netty/util/concurrent/Promise;Lio/netty/resolver/dns/DnsCache;)V
    ...
    iput-object p2, p0, Lio/netty/resolver/dns/DnsNameResolverContext;->resolveAddressTypes:[Lio/netty/channel/socket/InternetProtocolFamily;
    ...
    .line 11
    iget p1, p0, Lio/netty/resolver/dns/DnsNameResolverContext;->maxAllowedQueries:I

    iput p1, p0, Lio/netty/resolver/dns/DnsNameResolverContext;->allowedQueries:I
...
.method public static buildAliasMap(Lio/netty/handler/codec/dns/DnsResponse;)Ljava/util/Map;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private finishResolve()V
    ...
    .line 21
    iget-object v1, p0, Lio/netty/resolver/dns/DnsNameResolverContext;->promise:Lio/netty/util/concurrent/Promise;
...
.method private onResponseAorAAAA(Lio/netty/handler/codec/dns/DnsRecordType;Lio/netty/handler/codec/dns/DnsQuestion;Lio/netty/channel/AddressedEnvelope;)V
    ...
    invoke-interface {v0, v3}, Lio/netty/handler/codec/dns/DnsMessage;->count(Lio/netty/handler/codec/dns/DnsSection;)I
    ...
    invoke-interface {v0, v7, v5}, Lio/netty/handler/codec/dns/DnsMessage;->recordAt(Lio/netty/handler/codec/dns/DnsSection;I)Lio/netty/handler/codec/dns/DnsRecord;
    ...
    .line 17
    :try_start_0
    iget-object v8, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->hostname:Ljava/lang/String;
    ...
    .line 18
    iget-object v6, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->resolvedEntries:Ljava/util/List;
    ...
    iput-object v6, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->resolvedEntries:Ljava/util/List;
    ...
    .line 21
    iget-object v9, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->resolveCache:Lio/netty/resolver/dns/DnsCache;

    iget-object v10, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->hostname:Ljava/lang/String;

    invoke-interface {v7}, Lio/netty/handler/codec/dns/DnsRecord;->timeToLive()J

    move-result-wide v12

    iget-object v7, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->parent:Lio/netty/resolver/dns/DnsNameResolver;
    ...
    .line 22
    iget-object v7, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->resolvedEntries:Ljava/util/List;
    ...
    .line 24
    :cond_8
    iget-boolean v0, v1, Lio/netty/resolver/dns/DnsNameResolverContext;->traceEnabled:Z
    ...
    invoke-direct {p0, v0, v3}, Lio/netty/resolver/dns/DnsNameResolverContext;->addTrace(Ljava/net/InetSocketAddress;Ljava/lang/String;)V
    ...
    .line 27
    invoke-direct {p0, v0, v3, v2, v4}, Lio/netty/resolver/dns/DnsNameResolverContext;->onResponseCNAME(Lio/netty/handler/codec/dns/DnsQuestion;Lio/netty/channel/AddressedEnvelope;Ljava/util/Map;Z)V
